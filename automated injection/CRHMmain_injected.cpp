...
{
freopen("injection.xml", "a", stdout); printf("<int-_matherr-(struct-_exception-*a)>\n"); fclose(stdout);
...
__fastcall TMain::TMain(TComponent* Owner)
    : TForm(Owner)
{
freopen("injection.xml", "a", stdout); printf("<:-TForm(Owner)>\n"); fclose(stdout);
    ListHruNames = NULL;
    MapGrpNames = NULL;
    HruNames = False;
    dirty = false;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::FileDefaults(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::FormCreate(TObject-*Sender)>\n"); fclose(stdout);
    OpenDialogPrj->InitialDir = GetCurrentDir();
    SaveDialogPrj->InitialDir = GetCurrentDir();
    OpenDialogObs->InitialDir = GetCurrentDir();
    OpenDialogState->InitialDir = GetCurrentDir();
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::UpDownHRUIndxClick(TObject-*Sender,-TUDBtnType-Button)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ExitClick(TObject-*Sender)>\n"); fclose(stdout);
    Application->Terminate();
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::ExitClick(TObject-*Sender)>\n"); fclose(stdout);
}
void __fastcall TMain::OpenClick(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::OpenClick(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<bool-__fastcall-TMain::OpenObsFile(TObject-*Sender,-String-FileName)>\n"); fclose(stdout);
    ClassData  * FileData;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ObsCloseClick(TObject-*Sender)>\n"); fclose(stdout);
    TMenuItem *ObsItem;
    ObsItem = MainMenu1->Items->Items[1];
    if(ObsItem->Count <= 4)
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::BldModelClick(TObject-*Sender)>\n"); fclose(stdout);
    TMenuItem *ObsItem;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::RunClick(TObject-*Sender)>\n"); fclose(stdout);
    ClassVar *thisVar;
    float **mmsData;
    long **mmsDataL;
    bool GoodRun = true;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ExportClick(TObject-*Sender)>\n"); fclose(stdout);
    FileOutput->ShowModal();
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::ExportClick(TObject-*Sender)>\n"); fclose(stdout);
}
void __fastcall TMain::AboutClick(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::AboutClick(TObject-*Sender)>\n"); fclose(stdout);
    AboutBox->ShowModal();
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::AboutClick(TObject-*Sender)>\n"); fclose(stdout);
}
void __fastcall TMain::ListBox3Click(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ListBox3Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ConstructClick(TObject-*Sender)>\n"); fclose(stdout);
    LogForm->ClearRunLogs();
    FreeChart1(Sender);          
    BldForm->ShowModal();
    if(BldForm->Execute)
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::InitModules(TObject-*Sender)>\n"); fclose(stdout);
    ClassVar *thisVar;
    Global::BuildFlag = CRHM::DECL;
    Box1Disply = CRHM::OUTPUT; 
    for(Global::CurrentModuleRun = 0; Global::CurrentModuleRun < Global::OurModulesList->Count; Global::CurrentModuleRun++)
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ListBox4Click(TObject-*Sender)>\n"); fclose(stdout);
...
void __fastcall TMain::AddObsPlot(TObject *Sender, ClassVar *thisVar, TLineSeries *cdSeries, String S, CRHM::TFun Funct)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::AddObsPlot(TObject-*Sender,-ClassVar-*thisVar,-TLineSeries-*cdSeries,-String-S,-CRHM::TFun-Funct)>\n"); fclose(stdout);
    ClassVar *newVar;
    Global::HRU_OBS = Global::HRU_OBS_DIRECT; 
    Chart->Axes->Items[2]->Title->Caption = thisVar->units.c_str();
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::PrjExitClick(TObject-*Sender)>\n"); fclose(stdout);
    this->Close(); 
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::PrjExitClick(TObject-*Sender)>\n"); fclose(stdout);
}
void __fastcall TMain::ObsFileClose(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ObsFileClose(TObject-*Sender)>\n"); fclose(stdout);
    TMenuItem *ObsItem;
    MapVar::iterator itVar;
    ClassVar * thisVar;
    TMenuItem * thisMenu = (TMenuItem *) Sender;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::FormDestroy(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::DateTimePicker1Change(TObject-*Sender)>\n"); fclose(stdout);
    FreeChart2(Sender);
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::DateTimePicker1Change(TObject-*Sender)>\n"); fclose(stdout);
}
void __fastcall TMain::DateTimePicker2Change(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::DateTimePicker2Change(TObject-*Sender)>\n"); fclose(stdout);
    FreeChart2(Sender);
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::DateTimePicker2Change(TObject-*Sender)>\n"); fclose(stdout);
}
void __fastcall TMain::FreeChart1(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::FreeChart1(TObject-*Sender)>\n"); fclose(stdout);
    if(SeriesCnt > 0)
    {
        for (int ii = 0; ii < SeriesCnt; ii ++)
        {
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::FreeChart2(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::WMGetMinMaxInfo(TWMGetMinMaxInfo-&Msg)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::PrjSaveAsClick(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::PrjSaveClick(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::SaveProject(TObject-*Sender)>\n"); fclose(stdout);
    MapPar::iterator itPar;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::PrjOpenClick(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::DoPrjOpen(TObject-*Sender)>\n"); fclose(stdout);
    MapPar::iterator itPar;
    ClassPar *thisPar;
    ClassVar *thisVar;
    ifstream DataFile;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::PrjCloseClick(TObject-*Sender)>\n"); fclose(stdout);
    cancel = false;
    if(dirty)
    {
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ClearListBox4(TObject-*Sender)>\n"); fclose(stdout);
    for (int ii = 0; ii < ListBox4->Items->Count; ii++)
    {
        TLineSeries * cdSeries = (TLineSeries *) ListBox4->Items->Objects[ii];
        ClassVar* thisVar =  (ClassVar *) cdSeries->Tag;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ClearModulesClick(TObject-*Sender)>\n"); fclose(stdout);
    ClearModules(Sender, true);
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::ClearModulesClick(TObject-*Sender)>\n"); fclose(stdout);
}
void __fastcall TMain::ClearModules(TObject *Sender, bool All)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ClearModules(TObject-*Sender,-bool-All)>\n"); fclose(stdout);
    ModVarRemove(Global::MapVars);
    Global::SharedMapPars.clear();
    if(All)
        for(int ii = 0; ii < Global::OurModulesList->Count; ii++)
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::StatSaveStateAsClick(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::SaveState(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ControlSaveState(TObject-*Sender,-bool-MainLoop,-ClassPar-*-VarPar,-BitSet-&Bit)>\n"); fclose(stdout);
    TStringList *StateList;
    MapVar::iterator itVar;
    ClassVar * thisVar;
    StateList = new TStringList;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::StatSaveClick(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::StatOpenInitClick(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ReadStateFile(TObject-*Sender,-bool-&-GoodRun)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ResetLoopList(TObject-*Sender)>\n"); fclose(stdout);
    if(LoopList == NULL)
{freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::ResetLoopList(TObject-*Sender)>\n"); fclose(stdout);return;}
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ControlReadState(TObject-*Sender,-bool-MainLoop,-ClassPar-*-VarPar)>\n"); fclose(stdout);
    MapPar::iterator itVar;
    ClassVar *thisVar;
    String Sy;
    String Sx;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::OnHint(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::LogClick(TObject-*Sender)>\n"); fclose(stdout);
    LogForm->ShowModal();
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::LogClick(TObject-*Sender)>\n"); fclose(stdout);
}
void __fastcall TMain::ParametersClick(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ParametersClick(TObject-*Sender)>\n"); fclose(stdout);
    Parameter->ShowModal();
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::ParametersClick(TObject-*Sender)>\n"); fclose(stdout);
}
void __fastcall TMain::UpDownOBSIndxClick(TObject *Sender, TUDBtnType Button)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::UpDownOBSIndxClick(TObject-*Sender,-TUDBtnType-Button)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::UpdateDim(CRHM::TDim-Dim,-long-dim)>\n"); fclose(stdout);
    switch(Dim)
    {
    case CRHM::NHRU :
        Global::nhru = dim;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::HTMLhelp1Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::PrjAutoRunClick(TObject-*Sender)>\n"); fclose(stdout);
    if(PrjAutoRun->Checked)
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::RemoveSharedParams(void)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::SetSharedParams(ClassPar-*basinPar)>\n"); fclose(stdout);
    ClassPar *thisPar;
    MapPar::iterator itPar;
    for(itPar = Global::MapPars.begin(); itPar != Global::MapPars.end(); ++itPar)
    {
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::SqueezeParams(TObject-*Sender)>\n"); fclose(stdout);
    paras MapInfo; 
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::FormActivate(TObject-*Sender)>\n"); fclose(stdout);
#ifdef CRHM_DLL
#ifdef NO_MODULES
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::WMMainUpdateDim(TMessage-&Message)>\n"); fclose(stdout);
    UpdateDim((CRHM::TDim) Message.WParam, (long) Message.LParam);
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::WMMainUpdateDim(TMessage-&Message)>\n"); fclose(stdout);
}
void __fastcall TMain::WMMainUpdateStatus(TMessage &Message)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::WMMainUpdateStatus(TMessage-&Message)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::WMMainUpdateDirty(TMessage-&Message)>\n"); fclose(stdout);
    dirty = true;
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::WMMainUpdateDirty(TMessage-&Message)>\n"); fclose(stdout);
}
void __fastcall TMain::PrjReportClick(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::PrjReportClick(TObject-*Sender)>\n"); fclose(stdout);
    MapPar::iterator itPar;
    MapDim::iterator itDim;
    ClassPar *thisPar;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::DLL1OpenClick(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::DllFileCloseAux(String-FileName)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::DllFileClose(TObject-*Sender)>\n"); fclose(stdout);
    TMenuItem *DllItem;
    TMenuItem * thisMenu = (TMenuItem *) Sender;
    String S = thisMenu->Caption;
    if(!DllinUse(S))
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::DLL1CloseALLClick(TObject-*Sender)>\n"); fclose(stdout);
    TMenuItem *DllItem, *DllItem2;
    DllItem = MainMenu1->Items->Items[3];
    for(int ii = DllItem->Count-1; ii > 3; --ii)
    {
...
{
freopen("injection.xml", "a", stdout); printf("<bool-__fastcall-TMain::DllinUse(String-FileName)>\n"); fclose(stdout);
    for(int ii = 0; ii < Global::OurModulesList->Count; ii++)
    {
        ClassModule* thisModule = (ClassModule*) Global::OurModulesList->Objects[ii];
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::CompactDlls(void)>\n"); fclose(stdout);
    TMenuItem *DllItem;
...
{
freopen("injection.xml", "a", stdout); printf("<bool-__fastcall-TMain::OpenDLLFile(String-FileName)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::DllDelete(String-FileName)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::UpDateModelMenu(void)>\n"); fclose(stdout);
    TMenuItem *ObsItem, *NewItem;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::UpDateHelpMenu(void)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::DeleteListBox3Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::NegateListBox3Click(TObject-*Sender)>\n"); fclose(stdout);
    TComponent *pComponent = PopupListBox3->PopupComponent;
    if(pComponent)
    {
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox3")
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::AbsListBox3Click(TObject-*Sender)>\n"); fclose(stdout);
    TComponent *pComponent = PopupListBox3->PopupComponent;
    if(pComponent)
    {
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox3")
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ListBox4RemoveFuncts(TObject-*Sender,-String-Svar)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::DeleteListBox4Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::NegateListBox4Click(TObject-*Sender)>\n"); fclose(stdout);
    TComponent *pComponent = PopupListBox4->PopupComponent;
    if(pComponent)
    {
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox4")
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::AddListBox1Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ListBox1Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::AddListBox2Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ListBox2Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::FunctionListBox2Click(TObject-*Sender)>\n"); fclose(stdout);
    CoolBar1->Show(); 
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::FunctionListBox2Click(TObject-*Sender)>\n"); fclose(stdout);
}
void __fastcall TMain::LabelFunctClick(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::LabelFunctClick(TObject-*Sender)>\n"); fclose(stdout);
    if(Funct >= CRHM::DLTA)
        Funct = CRHM::FOBS;
    else
        Funct = (TFun) (Funct + 1);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::FormClick(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::OpenHelp(TObject-*Sender)>\n"); fclose(stdout);
    TMenuItem *thisMenu = (TMenuItem *) Sender;
    String Name;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::DoObsStatus(TObject-*Sender,-bool-&First)>\n"); fclose(stdout);
    if(First)
    {
        for(int ii = 0; ii < ObsFilesList->Count; ii++)
        {
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::HRUsAddListBox1Click(TObject-*Sender)>\n"); fclose(stdout);
    TComponent *pComponent = PopupListBox1->PopupComponent;
    if(pComponent)
    {
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox1")
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::LAYsAddListBox1Click(TObject-*Sender)>\n"); fclose(stdout);
    TComponent *pComponent = PopupListBox1->PopupComponent;
    if(pComponent)
    {
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox1")
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::HRUsLAYsAddListBox1Click(TObject-*Sender)>\n"); fclose(stdout);
    TComponent *pComponent = PopupListBox1->PopupComponent;
    if(pComponent)
    {
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox1")
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ResetPickers(void)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<bool-__fastcall-TMain::AppHelp(WORD-Command,-int-Data,-bool-&CallHelp)>\n"); fclose(stdout);
...
void __fastcall TMain::FlipTicMouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::FlipTicMouseDown(TObject-*Sender,-TMouseButton-Button,-TShiftState-Shift,-int-X,-int-Y)>\n"); fclose(stdout);
    bool flip;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::Analysis1Click(TObject-*Sender)>\n"); fclose(stdout);
    Analysis->ShowModal();
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::Analysis1Click(TObject-*Sender)>\n"); fclose(stdout);
}
void __fastcall TMain::FlowDiagramClick(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::FlowDiagramClick(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<String-__fastcall-TMain::ExtractHruLay(String-S,-long-&Hru,-long-&Lay)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<String-__fastcall-TMain::ExtractHruLayFunct(String-S,-long-&Hru,-long-&Lay,-String-&Funct,-String-&FullName)>\n"); fclose(stdout);
    long jj = S.LastDelimiter("(");
    long jj1 = S.Pos(",");
    long jj2 = S.LastDelimiter(")");
...
{
freopen("injection.xml", "a", stdout); printf("<String-__fastcall-TMain::BuildHru(String-S,-long-Hru,-CRHM::TDim-dimen)>\n"); fclose(stdout);
    if(!HruNames)
...
{
freopen("injection.xml", "a", stdout); printf("<String-__fastcall-TMain::BuildLay(String-S,-long-Lay)>\n"); fclose(stdout);
{freopen("injection.xml", "a", stdout); printf("</String-__fastcall-TMain::BuildLay(String-S,-long-Lay)>\n"); fclose(stdout);return S.SubString(1, S.Length()-1) + "," + String(Lay) + ")";}
freopen("injection.xml", "a", stdout); printf("</String-__fastcall-TMain::BuildLay(String-S,-long-Lay)>\n"); fclose(stdout);
}
void __fastcall TMain::HruNameClick(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::HruNameClick(TObject-*Sender)>\n"); fclose(stdout);
    MapPar::iterator itPar;
    ClassPar *newPar;
    long Hru, Lay;
...
{
freopen("injection.xml", "a", stdout); printf("<String-__fastcall-TMain::HRUStdString(String-S)>\n"); fclose(stdout);
    long Hru, Lay;
    if(ListHruNames)
    {
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::Last1Click(TObject-*Sender)>\n"); fclose(stdout);
    if(Last1->Checked)
        Last1->Checked = false;
    else
    {
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::All1Click(TObject-*Sender)>\n"); fclose(stdout);
    if(All1->Checked)
        All1->Checked = false;
    else
    {
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::DebugScreen1Click(TObject-*Sender)>\n"); fclose(stdout);
    if(DebugScreen1->Checked)
        DebugScreen1->Checked = false;
    else
        DebugScreen1->Checked = true;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::Last1Rprt(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::All1Rprt(TObject-*Sender)>\n"); fclose(stdout);
    TStringList *LogList = new TStringList;
    String S, Sx, Sy;
    ClassVar *thisVar;
    TDateTime Dt;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::DebugScreen1Rprt(TObject-*Sender)>\n"); fclose(stdout);
    ClassPar *thisPar;
    thisPar = ParFind("basin RUN_ID");
    long ID = 0;
    if(!thisPar)
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::AddArray1Click(TObject-*Sender)>\n"); fclose(stdout);
    TComponent *pComponent = PopupListBox2->PopupComponent;
    if(pComponent)
    {
        if((pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox2")
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::PrjAutoExitClick(TObject-*Sender)>\n"); fclose(stdout);
    if(PrjAutoExit->Checked)
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ParameterBackUp(TObject-*Sender)>\n"); fclose(stdout);
    MapPar::iterator itPar;
    ClassPar *thisPar;
    for(itPar = Global::MapPars.begin(); itPar != Global::MapPars.end(); ++itPar)
    {
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ParameterRestore(TObject-*Sender)>\n"); fclose(stdout);
    MapPar::iterator itPar;
    ClassPar *thisPar;
    for(itPar = Global::MapPars.begin(); itPar != Global::MapPars.end(); ++itPar)
    {
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::VariableBackUp(TObject-*Sender)>\n"); fclose(stdout);
    MapVar::iterator itVar;
    ClassVar *thisVar;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::VariableRestore(TObject-*Sender)>\n"); fclose(stdout);
    MapVar::iterator itVar;
    ClassVar *thisVar;
...
{
freopen("injection.xml", "a", stdout); printf("<ClassVar-*VarFind(string-name)>\n"); fclose(stdout);
    MapVar::iterator itVar;
...
{
freopen("injection.xml", "a", stdout); printf("<ClassPar-*ParFind(string-name)>\n"); fclose(stdout);
    MapPar::iterator itPar;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::Macro1Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::MacroLoad(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::FormClose(TObject-*Sender,-TCloseAction-&Action)>\n"); fclose(stdout);
    PrjCloseClick(Sender);
    if(cancel)
        Action = caNone; 
    else
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::AKA1Click(TObject-*Sender)>\n"); fclose(stdout);
    FormAKA->ShowModal();
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::AKA1Click(TObject-*Sender)>\n"); fclose(stdout);
}
bool __fastcall TMain::FindFileName(String &FileName)
{
freopen("injection.xml", "a", stdout); printf("<bool-__fastcall-TMain::FindFileName(String-&FileName)>\n"); fclose(stdout);
    String FilePart;
    String ApplicationDir = ExtractFilePath(AnsiReplaceStr(Application->ExeName, "/", "\\")); 
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::SaveChartTemplateClick(TObject-*Sender)>\n"); fclose(stdout);
    if(SaveChartTemplate->Checked)
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::UpdateOurModules(void)>\n"); fclose(stdout);
    for(int ii = 0; ii < Global::OurModulesList->Count; ii++)
    {
        int jj = Global::AllModulesList->IndexOf(Global::OurModulesList->Strings[ii]);
        if(jj < 0)
...
{
freopen("injection.xml", "a", stdout); printf("<long-__fastcall-TMain::IndexOf(TListBox-*Box,-const-AnsiString-S)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::AddObsFunct1Click(TObject-*Sender)>\n"); fclose(stdout);
    TComponent *pComponent = PopupListBox3->PopupComponent;
    if(pComponent)
    {
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox3")
...
{
freopen("injection.xml", "a", stdout); printf("<CRHM::TFun-FindObservationType(String-Kind)>\n"); fclose(stdout);
    if(Kind == "_obs")
        Kind = "";
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ListBoxMacroClear(TObject-*Sender)>\n"); fclose(stdout);
    ClassVar * thisVar;
    if(SeriesCnt <= 0)
        ListBox3->Clear();
    else
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::StateFileClose(TObject-*Sender)>\n"); fclose(stdout);
    TMenuItem *ObsItem;
    TMenuItem * thisMenu = (TMenuItem *) Sender;
    ObsItem = MainMenu1->Items->Items[5];
    if(ObsItem->Count > 5)
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::StateFileCloseAll(TObject-*Sender)>\n"); fclose(stdout);
    TMenuItem *StateItem;
    StateItem = MainMenu1->Items->Items[5];
    if(StateItem->Count > 5)  
    {
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::LastRprtObs(TObject-*Sender)>\n"); fclose(stdout);
    bool Daily;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::AllRprtObs(TObject-*Sender)>\n"); fclose(stdout);
    bool Daily;
    int SeriesCnt = ListBox4->Items->Count;
    if(SeriesCnt <= 0)
{freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::AllRprtObs(TObject-*Sender)>\n"); fclose(stdout);return;}
...
{
freopen("injection.xml", "a", stdout); printf("<bool-__fastcall-TMain::FileExistsSp(String-FileName)>\n"); fclose(stdout);
    ifstream DataFile;
...
{
freopen("injection.xml", "a", stdout); printf("<String-__fastcall-TMain::DeclObsName(ClassVar-*thisVar)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::Label4Click(TObject-*Sender)>\n"); fclose(stdout);
    ClassVar *thisVar;
    MapVar::iterator itVar;
...
{
freopen("injection.xml", "a", stdout); printf("<bool-__fastcall-TMain::isSimple(string-module)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<bool-TMain::Variation_Decide(int-Variation_set,-long-Variation)>\n"); fclose(stdout);
    VandP V;
    V.Set(Variation);
...
void __fastcall TMain::ListBox1KeyDown(TObject *Sender, WORD &Key, TShiftState Shift)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ListBox1KeyDown(TObject-*Sender,-WORD-&Key,-TShiftState-Shift)>\n"); fclose(stdout);
    if(Shift.Contains(ssShift))
        ShiftDown = true;
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::ListBox1KeyDown(TObject-*Sender,-WORD-&Key,-TShiftState-Shift)>\n"); fclose(stdout);
}
void __fastcall TMain::ListBox1KeyUp(TObject *Sender, WORD &Key, TShiftState Shift)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::ListBox1KeyUp(TObject-*Sender,-WORD-&Key,-TShiftState-Shift)>\n"); fclose(stdout);
    ShiftDown = false;
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::ListBox1KeyUp(TObject-*Sender,-WORD-&Key,-TShiftState-Shift)>\n"); fclose(stdout);
}
void __fastcall TMain::FreqDefault1Click(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::FreqDefault1Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<long-__fastcall-TMain::CheckforModule(String-S,-long-Pos)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::daily1Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::biweekly1Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::weekly1Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::monthly1Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::yearly1Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::atend1Click(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::VarObsFunct_Update(TObject-*Sender)>\n"); fclose(stdout);
    ClassVar* thisVar;
    ClassVar* orgVar;
    CRHM::TFun Funct;
    long Index;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::SummaryScreen1Click(TObject-*Sender)>\n"); fclose(stdout);
    if(SummaryScreen1->Checked)
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::SummaryScreen1Rprt(TObject-*Sender)>\n"); fclose(stdout);
    TStringList *LogList = new TStringList;
    String S, Sx, Sy;
...
void __fastcall TMain::LabelBaseMouseDown(TObject *Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::LabelBaseMouseDown(TObject-*Sender,-TMouseButton-Button,-TShiftState-Shift,-int-X,-int-Y)>\n"); fclose(stdout);
    if (Button == mbRight)
    {
        ++water_year_month;
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::MacroLoad_X(TObject-*Sender)>\n"); fclose(stdout);
    MacroLoad(Sender);
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::MacroLoad_X(TObject-*Sender)>\n"); fclose(stdout);
}
void __fastcall TMain::RadioGroupFunctClick(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::RadioGroupFunctClick(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::RadioGroupDisplayClick(TObject-*Sender)>\n"); fclose(stdout);
...
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::CancelScreenClick(TObject-*Sender)>\n"); fclose(stdout);
    CoolBar1->Hide();
freopen("injection.xml", "a", stdout); printf("</void-__fastcall-TMain::CancelScreenClick(TObject-*Sender)>\n"); fclose(stdout);
}
void __fastcall TMain::CheckBlankModule(TObject *Sender)
{
freopen("injection.xml", "a", stdout); printf("<void-__fastcall-TMain::CheckBlankModule(TObject-*Sender)>\n"); fclose(stdout);
    MapVar::iterator itVar;
    ClassVar * thisVar;
    for (itVar = Global::MapVars.begin(); itVar !=  Global::MapVars.end(); itVar++)
    {
...
{
freopen("injection.xml", "a", stdout); printf("<long-__fastcall-TMain::FindWildVarFloat(string-name,-ClassVar*-&newVar,-bool-OnceFlag)>\n"); fclose(stdout);
