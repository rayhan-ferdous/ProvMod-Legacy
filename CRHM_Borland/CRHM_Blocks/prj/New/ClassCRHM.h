...
class __declspec(dllexport) ClassVar {
    ...
    typedef void (ClassVar:: *TLoopFunct) (long); // -1 - nothing, 0 - reset, 1 - reset -1000000, 2 - reset 1000000, 3 - divide by Freq
    ...
    ClassVar *FunctVar;
    TLoopFunct LoopFunct;  // typedef void (ClassVar:: *SomeFunct) (void) used in ClassCRHM
    TSomeFunct UserFunct;  // typedef void (ClassVar:: *SomeFunct) (void) used in ClassCRHM
    TAccFunct CustomFunct; // typedef void (ClassVar:: *AccFunct) (ClassModule *) used in ClassModule
    String CustomFunctName; // debug aid
    long No_ReadVar; // do not read observation but use CustomFunct
    ...
    virtual void LoopFirst(long Options);

    virtual void LoopLast(long Options);

    virtual void LoopRange(long Options);

    virtual void Avg_(void);

    virtual void Min_(void);

    virtual void Max_(void);

//    virtual void Tot_(void);

    virtual void First_(void);

    virtual void Last_(void);

    virtual void Peak_(void);

    virtual void Count_(void);

    virtual void Count0_(void);

    virtual void Delta_(void);

    virtual void Pos_(void);
    ...
    virtual void do_t_Clim(ClassModule *thisModule);

    virtual void do_t_day(ClassModule *thisModule);

    virtual void do_t_day_Clim(ClassModule *thisModule);

    virtual void do_rh_day(ClassModule *thisModule);

    virtual void do_rh_day_Clim(ClassModule *thisModule);

    virtual void do_ea_day(ClassModule *thisModule);

    virtual void do_ppt(ClassModule *thisModule);

    virtual void do_p(ClassModule *thisModule);

    virtual void do_p_Clim(ClassModule *thisModule);

    virtual void do_ppt_Clim(ClassModule *thisModule);
