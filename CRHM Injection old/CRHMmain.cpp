...
{
//raf835:injection
    cout << "signature# 1 @ int _matherr (struct _exception *a)";
...
{
//raf835:injection
    cout << "signature# 3 @ void __fastcall TMain::FileDefaults(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 4 @ void __fastcall TMain::FormCreate(TObject *Sender)";
    OpenDialogPrj->InitialDir = GetCurrentDir();
    SaveDialogPrj->InitialDir = GetCurrentDir();
    OpenDialogObs->InitialDir = GetCurrentDir();
    OpenDialogState->InitialDir = GetCurrentDir();
...
{
//raf835:injection
    cout << "signature# 5 @ void __fastcall TMain::UpDownHRUIndxClick(TObject *Sender, TUDBtnType Button)";
...
{
//raf835:injection
    cout << "signature# 6 @ void __fastcall TMain::ExitClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 7 @ void __fastcall TMain::OpenClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 8 @ bool __fastcall TMain::OpenObsFile(TObject *Sender, String FileName)";
    ClassData  * FileData;
...
{
//raf835:injection
    cout << "signature# 9 @ void __fastcall TMain::ObsCloseClick(TObject *Sender)";
    TMenuItem *ObsItem;
    ObsItem = MainMenu1->Items->Items[1];
...
{
//raf835:injection
    cout << "signature# 10 @ void __fastcall TMain::BldModelClick(TObject *Sender)";
    TMenuItem *ObsItem;
...
{
//raf835:injection
    cout << "signature# 11 @ void __fastcall TMain::RunClick(TObject *Sender)";
    ClassVar *thisVar;
    float **mmsData;
    long **mmsDataL;
    bool GoodRun = true;
...
{
//raf835:injection
    cout << "signature# 12 @ void __fastcall TMain::ExportClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 13 @ void __fastcall TMain::AboutClick(TObject *Sender)";
    AboutBox->ShowModal();
}
//---------------------------------------------------------------------------
...
{
//raf835:injection
    cout << "signature# 14 @ void __fastcall TMain::ListBox3Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 15 @ void __fastcall TMain::ConstructClick(TObject *Sender)";
    LogForm->ClearRunLogs();
    FreeChart1(Sender);          // remove series and clear ListBox4
...
{
//raf835:injection
    cout << "signature# 16 @ void __fastcall TMain::InitModules(TObject *Sender)";
    ClassVar *thisVar;
    Global::BuildFlag = CRHM::DECL;
...
{
//raf835:injection
    cout << "signature# 17 @ void __fastcall TMain::ListBox4Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 18 @ TLineSeries *cdSeries, String S, CRHM::TFun Funct)";
    ClassVar *newVar;
...
if(Global::DTindx*Global::Freq/thisVar->FileData->Freq >= IndxMin)
    if(Global::DTindx*thisVar->FileData->Freq/Global::Freq > IndxMax)
        break;
    else if(Global::Interval >= 1) --Global::DTnow;
dattim("now", itime);
switch(TBase)
case 0: // daily
...
{
//raf835:injection
    cout << "signature# 19 @ void __fastcall TMain::ObsFileClose(TObject *Sender)";
    TMenuItem *ObsItem;
    MapVar::iterator itVar;
    ClassVar * thisVar;
    TMenuItem * thisMenu = (TMenuItem *) Sender;
...
{
//raf835:injection
    cout << "signature# 20 @ void __fastcall TMain::FormDestroy(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 21 @ void __fastcall TMain::DateTimePicker1Change(TObject *Sender)";
    FreeChart2(Sender);
}
//---------------------------------------------------------------------------
...
{
//raf835:injection
    cout << "signature# 22 @ void __fastcall TMain::DateTimePicker2Change(TObject *Sender)";
    FreeChart2(Sender);
}
//---------------------------------------------------------------------------
...
{
//raf835:injection
    cout << "signature# 23 @ void __fastcall TMain::FreeChart1(TObject *Sender)";
    if(SeriesCnt > 0)
        for (int ii = 0; ii < SeriesCnt; ii ++)
...
{
//raf835:injection
    cout << "signature# 24 @ void __fastcall TMain::FreeChart2(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 25 @ void __fastcall TMain::WMGetMinMaxInfo(TWMGetMinMaxInfo &Msg)";
...
{
//raf835:injection
    cout << "signature# 26 @ void __fastcall TMain::PrjSaveAsClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 27 @ void __fastcall TMain::PrjSaveClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 28 @ void __fastcall TMain::SaveProject(TObject *Sender)";
    MapPar::iterator itPar;
...
{
//raf835:injection
    cout << "signature# 29 @ void __fastcall TMain::PrjOpenClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 30 @ void __fastcall TMain::DoPrjOpen(TObject *Sender)";
    MapPar::iterator itPar;
    ClassPar *thisPar;
    ClassVar *thisVar;
    ifstream DataFile;
...
else if(String(param) != "Use_Observations_As_Supplied")
...
{
//raf835:injection
    cout << "signature# 31 @ void __fastcall TMain::PrjCloseClick(TObject *Sender)";
    cancel = false;
    if(dirty)
...
{
//raf835:injection
    cout << "signature# 32 @ void __fastcall TMain::ClearListBox4(TObject *Sender)";
    for (int ii = 0; ii < ListBox4->Items->Count; ii++)
        TLineSeries * cdSeries = (TLineSeries *) ListBox4->Items->Objects[ii];
    ClassVar* thisVar =  (ClassVar *) cdSeries->Tag;
...
{
//raf835:injection
    cout << "signature# 33 @ void __fastcall TMain::ClearModulesClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 34 @ void __fastcall TMain::ClearModules(TObject *Sender, bool All)";
    ModVarRemove(Global::MapVars);
    Global::SharedMapPars.clear();
    if(All)
        for(int ii = 0; ii < Global::OurModulesList->Count; ii++)
...
{
//raf835:injection
    cout << "signature# 35 @ void __fastcall TMain::StatSaveStateAsClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 36 @ void __fastcall TMain::SaveState(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 37 @ void __fastcall TMain::ControlSaveState(TObject *Sender, bool MainLoop, ClassPar * VarPar, BitSet &Bit)";
    TStringList *StateList;
    MapVar::iterator itVar;
    ClassVar * thisVar;
    StateList = new TStringList;
...
{
//raf835:injection
    cout << "signature# 38 @ void __fastcall TMain::StatSaveClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 39 @ void __fastcall TMain::StatOpenInitClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 40 @ void __fastcall TMain::ReadStateFile(TObject *Sender, bool & GoodRun)";
...
{
//raf835:injection
    cout << "signature# 41 @ void __fastcall TMain::ControlReadState(TObject *Sender, bool MainLoop, ClassPar * VarPar)";
    MapPar::iterator itVar;
    ClassVar *thisVar;
    String Sy;
    String Sx;
    ...
    if(exist > -1)
        mod = (ClassModule*) Global::OurModulesList->Objects[exist];
    else if(MainLoop) // assume otherwise OK
    {
        Application->MessageBox((String("State File module ") + module).c_str(),
                                "Unknown module", MB_OK);
        DataFile.ignore(180, '#');
...
{
//raf835:injection
    cout << "signature# 42 @ void __fastcall TMain::OnHint(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 43 @ void __fastcall TMain::LogClick(TObject *Sender)";
    LogForm->ShowModal();
}
//---------------------------------------------------------------------------
...
{
//raf835:injection
    cout << "signature# 44 @ void __fastcall TMain::ParametersClick(TObject *Sender)";
    Parameter->ShowModal();
}
//---------------------------------------------------------------------------
...
{
//raf835:injection
    cout << "signature# 45 @ void __fastcall TMain::UpDownOBSIndxClick(TObject *Sender, TUDBtnType Button)";
...
{
//raf835:injection
    cout << "signature# 46 @ void __fastcall TMain::UpdateDim(CRHM::TDim Dim, long dim)";
    switch(Dim)
    case CRHM::NHRU :
    Global::nhru = dim;
    Global::maxhru = dim;
...
{
//raf835:injection
    cout << "signature# 47 @ void __fastcall TMain::HTMLhelp1Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 48 @ void __fastcall TMain::PrjAutoRunClick(TObject *Sender)";
    if(PrjAutoRun->Checked)
...
{
//raf835:injection
    cout << "signature# 49 @ void __fastcall TMain::SetSharedParams(ClassPar *basinPar)";
...
{
//raf835:injection
    cout << "signature# 50 @ void __fastcall TMain::SqueezeParams(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 51 @ void __fastcall TMain::FormActivate(TObject *Sender)";
#ifdef CRHM_DLL
#ifdef NO_MODULES
...
{
//raf835:injection
    cout << "signature# 52 @ void __fastcall TMain::WMMainUpdateDim(TMessage &Message)";
...
{
//raf835:injection
    cout << "signature# 53 @ void __fastcall TMain::WMMainUpdateStatus(TMessage &Message)";
...
{
//raf835:injection
    cout << "signature# 54 @ void __fastcall TMain::WMMainUpdateDirty(TMessage &Message)";
    dirty = true;
}
//---------------------------------------------------------------------------
...
{
//raf835:injection
    cout << "signature# 55 @ void __fastcall TMain::PrjReportClick(TObject *Sender)";
    MapPar::iterator itPar;
    MapDim::iterator itDim;
    ClassPar *thisPar;
...
{
//raf835:injection
    cout << "signature# 56 @ void __fastcall TMain::DLL1OpenClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 57 @ void __fastcall TMain::DllFileCloseAux(String FileName)";
...
{
//raf835:injection
    cout << "signature# 58 @ void __fastcall TMain::DllFileClose(TObject *Sender)";
    TMenuItem *DllItem;
    TMenuItem * thisMenu = (TMenuItem *) Sender;
    String S = thisMenu->Caption;
    if(!DllinUse(S))
...
{
//raf835:injection
    cout << "signature# 59 @ void __fastcall TMain::DLL1CloseALLClick(TObject *Sender)";
    TMenuItem *DllItem, *DllItem2;
    DllItem = MainMenu1->Items->Items[3];
...
{
//raf835:injection
    cout << "signature# 60 @ bool __fastcall TMain::DllinUse(String FileName)";
    for(int ii = 0; ii < Global::OurModulesList->Count; ii++)
        ClassModule* thisModule = (ClassModule*) Global::OurModulesList->Objects[ii];
...
{
//raf835:injection
    cout << "signature# 61 @ void __fastcall TMain::CompactDlls(void)";
    TMenuItem *DllItem;
...
{
//raf835:injection
    cout << "signature# 62 @ bool __fastcall TMain::OpenDLLFile(String FileName)";
...
{
//raf835:injection
    cout << "signature# 63 @ void __fastcall TMain::DllDelete(String FileName)";
...
{
//raf835:injection
    cout << "signature# 64 @ void __fastcall TMain::UpDateModelMenu(void)";
    TMenuItem *ObsItem, *NewItem;
// Handle build menu
...
{
//raf835:injection
    cout << "signature# 65 @ void __fastcall TMain::UpDateHelpMenu(void)";
...
{
//raf835:injection
    cout << "signature# 66 @ void __fastcall TMain::DeleteListBox3Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 67 @ void __fastcall TMain::NegateListBox3Click(TObject *Sender)";
    TComponent *pComponent = PopupListBox3->PopupComponent;
    if(pComponent)
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox3")
            int StartCnt = ListBox3->Items->Count;
...
{
//raf835:injection
    cout << "signature# 68 @ void __fastcall TMain::AbsListBox3Click(TObject *Sender)";
    TComponent *pComponent = PopupListBox3->PopupComponent;
    if(pComponent)
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox3")
            int StartCnt = ListBox3->Items->Count;
...
{
//raf835:injection
    cout << "signature# 69 @ void __fastcall TMain::ListBox4RemoveFuncts(TObject *Sender, String Svar)";
...
{
//raf835:injection
    cout << "signature# 70 @ void __fastcall TMain::DeleteListBox4Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 71 @ void __fastcall TMain::NegateListBox4Click(TObject *Sender)";
    TComponent *pComponent = PopupListBox4->PopupComponent;
    if(pComponent)
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox4")
            int StartCnt = ListBox4->Items->Count;
...
{
//raf835:injection
    cout << "signature# 72 @ void __fastcall TMain::AddListBox1Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 73 @ void __fastcall TMain::ListBox1Click(TObject *Sender)";
...
else if(thisVar->lay > UpDownOBSIndx->Max)
...
{
//raf835:injection
    cout << "signature# 74 @ void __fastcall TMain::AddListBox2Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 75 @ void __fastcall TMain::ListBox2Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 76 @ void __fastcall TMain::FunctionListBox2Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 77 @ void __fastcall TMain::LabelFunctClick(TObject *Sender)";
    if(Funct >= CRHM::DLTA)
        Funct = CRHM::FOBS;
    else
        Funct = (TFun) (Funct + 1);
...
{
//raf835:injection
    cout << "signature# 78 @ void __fastcall TMain::FormClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 79 @ void __fastcall TMain::OpenHelp(TObject *Sender)";
    TMenuItem *thisMenu = (TMenuItem *) Sender;
    String Name;
...
{
//raf835:injection
    cout << "signature# 80 @ void __fastcall TMain::DoObsStatus(TObject *Sender, bool &First)";
    if(First)
        for(int ii = 0; ii < ObsFilesList->Count; ii++)
            ClassData * FileData = (ClassData *) ObsFilesList->Objects[ii];
    FileData->TimeIndx = 0;
...
{
//raf835:injection
    cout << "signature# 81 @ void __fastcall TMain::HRUsAddListBox1Click(TObject *Sender)";
    TComponent *pComponent = PopupListBox1->PopupComponent;
    if(pComponent)
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox1")
            int StartCnt = ListBox1->Items->Count;
...
{
//raf835:injection
    cout << "signature# 82 @ void __fastcall TMain::LAYsAddListBox1Click(TObject *Sender)";
    TComponent *pComponent = PopupListBox1->PopupComponent;
    if(pComponent)
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox1")
            int StartCnt = ListBox1->Items->Count;
...
{
//raf835:injection
    cout << "signature# 83 @ void __fastcall TMain::HRUsLAYsAddListBox1Click(TObject *Sender)";
    TComponent *pComponent = PopupListBox1->PopupComponent;
    if(pComponent)
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox1")
            int StartCnt = ListBox1->Items->Count;
...
{
//raf835:injection
    cout << "signature# 84 @ void __fastcall TMain::ResetPickers(void)";
...
{
//raf835:injection
    cout << "signature# 85 @ bool __fastcall TMain::AppHelp(WORD Command, int Data, bool &CallHelp)";
...
{
//raf835:injection
    cout << "signature# 86 @ TMouseButton Button, TShiftState Shift, int X, int Y)";
    bool flip;
...
{
//raf835:injection
    cout << "signature# 87 @ void __fastcall TMain::Analysis1Click(TObject *Sender)";
    Analysis->ShowModal();
}
//---------------------------------------------------------------------------
...
{
//raf835:injection
    cout << "signature# 88 @ void __fastcall TMain::FlowDiagramClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 89 @ String __fastcall TMain::ExtractHruLay(String S, long &Hru, long &Lay)";
...
{
//raf835:injection
    cout << "signature# 90 @ String __fastcall TMain::ExtractHruLayFunct(String S, long &Hru, long &Lay, String &Funct, String &FullName)";
    long jj = S.LastDelimiter("(");
    long jj1 = S.Pos(",");
    long jj2 = S.LastDelimiter(")");
...
{
//raf835:injection
    cout << "signature# 91 @ String __fastcall TMain::BuildHru(String S, long Hru, CRHM::TDim dimen)";
    if(!HruNames)
        return S  + "(" + String(Hru) + ")";
    else
        String SS;
...
{
//raf835:injection
    cout << "signature# 92 @ String __fastcall TMain::BuildLay(String S, long Lay)";
...
{
//raf835:injection
    cout << "signature# 93 @ void __fastcall TMain::HruNameClick(TObject *Sender)";
    MapPar::iterator itPar;
    ClassPar *newPar;
    long Hru, Lay;
...
{
//raf835:injection
    cout << "signature# 94 @ void __fastcall TMain::Last1Click(TObject *Sender)";
    if(Last1->Checked)
        Last1->Checked = false;
    else
        Last1->Checked = true;
...
{
//raf835:injection
    cout << "signature# 95 @ void __fastcall TMain::All1Click(TObject *Sender)";
    if(All1->Checked)
        All1->Checked = false;
    else
        All1->Checked = true;
...
{
//raf835:injection
    cout << "signature# 96 @ void __fastcall TMain::DebugScreen1Click(TObject *Sender)";
    if(DebugScreen1->Checked)
        DebugScreen1->Checked = false;
    else
        DebugScreen1->Checked = true;
...
{
//raf835:injection
    cout << "signature# 97 @ void __fastcall TMain::Last1Rprt(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 98 @ void __fastcall TMain::All1Rprt(TObject *Sender)";
    TStringList *LogList = new TStringList;
    String S, Sx, Sy;
    ClassVar *thisVar;
    TDateTime Dt;
...
{
//raf835:injection
    cout << "signature# 99 @ void __fastcall TMain::DebugScreen1Rprt(TObject *Sender)";
    ClassPar *thisPar;
    thisPar = ParFind("basin RUN_ID");
    long ID = 0;
    if(!thisPar)
...
{
//raf835:injection
    cout << "signature# 100 @ void __fastcall TMain::AddArray1Click(TObject *Sender)";
    TComponent *pComponent = PopupListBox2->PopupComponent;
    if(pComponent)
        if((pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox2")
                || (pComponent->ClassNameIs("TLabel") && pComponent->Name == "LabelFunct"))
...
{
//raf835:injection
    cout << "signature# 101 @ void __fastcall TMain::PrjAutoExitClick(TObject *Sender)";
    if(PrjAutoExit->Checked)
...
{
//raf835:injection
    cout << "signature# 102 @ void __fastcall TMain::ParameterBackUp(TObject *Sender)";
    MapPar::iterator itPar;
    ClassPar *thisPar;
    for(itPar = Global::MapPars.begin(); itPar != Global::MapPars.end(); ++itPar)
        thisPar = (*itPar).second;
...
{
//raf835:injection
    cout << "signature# 103 @ void __fastcall TMain::ParameterRestore(TObject *Sender)";
    MapPar::iterator itPar;
    ClassPar *thisPar;
    for(itPar = Global::MapPars.begin(); itPar != Global::MapPars.end(); ++itPar)
        thisPar = (*itPar).second;
...
{
//raf835:injection
    cout << "signature# 104 @ void __fastcall TMain::VariableBackUp(TObject *Sender)";
    MapVar::iterator itVar;
    ClassVar *thisVar;
...
{
//raf835:injection
    cout << "signature# 105 @ void __fastcall TMain::VariableRestore(TObject *Sender)";
    MapVar::iterator itVar;
    ClassVar *thisVar;
...
{
//raf835:injection
    cout << "signature# 106 @ ClassVar *VarFind(string name)";
    MapVar::iterator itVar;
...
{
//raf835:injection
    cout << "signature# 107 @ void __fastcall TMain::Macro1Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 108 @ void __fastcall TMain::MacroLoad(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 109 @ void __fastcall TMain::AKA1Click(TObject *Sender)";
    FormAKA->ShowModal();
}
//---------------------------------------------------------------------------
...
{
//raf835:injection
    cout << "signature# 110 @ bool __fastcall TMain::FindFileName(String &FileName)";
    String FilePart;
    String ApplicationDir = ExtractFilePath(AnsiReplaceStr(Application->ExeName, "/", "\\")); // Fix for "C:/Program files/CRHM/Examples
...
{
//raf835:injection
    cout << "signature# 111 @ void __fastcall TMain::SaveChartTemplateClick(TObject *Sender)";
    if(SaveChartTemplate->Checked)
...
{
//raf835:injection
    cout << "signature# 112 @ void __fastcall TMain::UpdateOurModules(void)";
    for(int ii = 0; ii < Global::OurModulesList->Count; ii++)
        int jj = Global::AllModulesList->IndexOf(Global::OurModulesList->Strings[ii]);
    if(jj < 0)
        CRHMException Except((Global::OurModulesList->Strings[ii] + " Module not defined in CRHM model").c_str(), ERR);
...
{
//raf835:injection
    cout << "signature# 113 @ long __fastcall TMain::IndexOf(TListBox *Box, const AnsiString S)";
...
{
//raf835:injection
    cout << "signature# 114 @ void __fastcall TMain::AddObsFunct1Click(TObject *Sender)";
    TComponent *pComponent = PopupListBox3->PopupComponent;
    if(pComponent)
        if(pComponent->ClassNameIs("TListBox") && pComponent->Name == "ListBox3")
            for(int ii = 0; ii < ListBox3->Items->Count; ++ii)
...
{
//raf835:injection
    cout << "signature# 115 @ CRHM::TFun  FindObservationType(String Kind)";
    if(Kind == "_obs") Kind = "";
...
{
//raf835:injection
    cout << "signature# 116 @ void __fastcall TMain::StateFileClose(TObject *Sender)";
    TMenuItem *ObsItem;
    TMenuItem * thisMenu = (TMenuItem *) Sender;
    ObsItem = MainMenu1->Items->Items[5];
    if(ObsItem->Count > 5)
...
{
//raf835:injection
    cout << "signature# 117 @ void __fastcall TMain::StateFileCloseAll(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 118 @ void __fastcall TMain::LastRprtObs(TObject *Sender)";
    bool Daily;
...
{
//raf835:injection
    cout << "signature# 119 @ void __fastcall TMain::AllRprtObs(TObject *Sender)";
    bool Daily;
    int SeriesCnt = ListBox4->Items->Count;
    if(SeriesCnt <= 0) return;
    TLineSeries *cdS = (TLineSeries *) ListBox4->Items->Objects[0];
...
{
//raf835:injection
    cout << "signature# 120 @ bool __fastcall TMain::FileExistsSp(String FileName)";
    ifstream DataFile;
...
{
//raf835:injection
    cout << "signature# 121 @ String __fastcall TMain::DeclObsName(ClassVar *thisVar)";
...
{
//raf835:injection
    cout << "signature# 122 @ void __fastcall TMain::Label4Click(TObject *Sender)";
    ClassVar *thisVar;
    MapVar::iterator itVar;
...
{
//raf835:injection
    cout << "signature# 123 @ bool TMain::Variation_Decide(int Variation_set, long Variation)";
    VandP V;
    V.Set(Variation);
...
{
//raf835:injection
    cout << "signature# 124 @ TShiftState Shift)";
...
{
//raf835:injection
    cout << "signature# 125 @ TShiftState Shift)";
    ShiftDown = false;
}
//---------------------------------------------------------------------------
...
{
//raf835:injection
    cout << "signature# 126 @ void __fastcall TMain::FreqDefault1Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 127 @ long __fastcall TMain::CheckforModule(String S, long Pos)";
...
{
//raf835:injection
    cout << "signature# 128 @ void __fastcall TMain::daily1Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 129 @ void __fastcall TMain::biweekly1Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 130 @ void __fastcall TMain::weekly1Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 131 @ void __fastcall TMain::monthly1Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 132 @ void __fastcall TMain::yearly1Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 133 @ void __fastcall TMain::atend1Click(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 134 @ void __fastcall TMain::VarObsFunct_Update(TObject *Sender)";
    ClassVar* thisVar;
    ClassVar* orgVar;
    CRHM::TFun Funct;
    long Index;
...
{
//raf835:injection
    cout << "signature# 135 @ void __fastcall TMain::SummaryScreen1Click(TObject *Sender)";
    if(SummaryScreen1->Checked)
...
{
//raf835:injection
    cout << "signature# 136 @ void __fastcall TMain::SummaryScreen1Rprt(TObject *Sender)";
    TStringList *LogList = new TStringList;
    String S, Sx, Sy;
...
{
//raf835:injection
    cout << "signature# 137 @ TMouseButton Button, TShiftState Shift, int X, int Y)";
    if (Button == mbRight)
        ++water_year_month;
...
{
//raf835:injection
    cout << "signature# 138 @ void __fastcall TMain::MacroLoad_X(TObject *Sender)";
    MacroLoad(Sender);
}
//---------------------------------------------------------------------------
...
{
//raf835:injection
    cout << "signature# 139 @ void __fastcall TMain::RadioGroupFunctClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 140 @ void __fastcall TMain::RadioGroupDisplayClick(TObject *Sender)";
...
{
//raf835:injection
    cout << "signature# 141 @ void __fastcall TMain::CancelScreenClick(TObject *Sender)";
    CoolBar1->Hide();
}
//---------------------------------------------------------------------------
...
{
//raf835:injection
    cout << "signature# 142 @ void __fastcall TMain::CheckBlankModule(TObject *Sender)";
    MapVar::iterator itVar;
    ClassVar * thisVar;
    for (itVar = Global::MapVars.begin(); itVar !=  Global::MapVars.end(); itVar++)
        thisVar = (*itVar).second;
...
{
//raf835:injection
    cout << "signature# 143 @ long __fastcall TMain::FindWildVarFloat(string name, ClassVar* &newVar, bool OnceFlag)";
