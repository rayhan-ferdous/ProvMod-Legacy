...
Classshared* klone() const;
};

class Classbasin : public ClassModule {
public:

Classbasin(string Name, string Version = "undefined", CRHM::LMODULE Lvl = CRHM::PROTO) : ClassModule(Name, Version, Lvl) {}; // string
// declared parameters
const long *RUN_ID;
...
// variable inputs
    ...
    ClassSimpleRichard* klone() const;
...
ClassalbedoRichard* klone() const;
};
...
Classwalmsley_wind* klone() const;
};
...
ClassCRHMCanopyClearing* klone() const;
...
ClassCRHMCanopyClearingGap* klone() const;
...
ClassalbedoWinstral* klone() const;
};
