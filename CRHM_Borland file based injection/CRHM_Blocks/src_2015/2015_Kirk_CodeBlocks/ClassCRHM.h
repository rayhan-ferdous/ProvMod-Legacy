...
class ClassVar {
    ...
    typedef void (ClassVar:: *TLoopFunct) (void);
    ...
    ClassVar *FunctVar;
    TLoopFunct LoopFunct;  // typedef void (ClassVar:: *LoopFunct) (void) used in ClassCRHM
    ...
    virtual void LoopFirst(void);

    virtual void LoopLast(void);

    virtual void LoopRange(void);
