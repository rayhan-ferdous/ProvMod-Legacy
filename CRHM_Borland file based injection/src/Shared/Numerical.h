...
public:
    Poly(int NumPoints, float x[], float y[], int NumTerms) :
        LeastSquares(NumPoints, x, y, NumTerms,
                     "Polynomial Least Squares Fit", "Poly")
    {
        DoIt();
    };
    ...
    Poly(TLineSeries *Data, bool OffsetTime, int NumTerms) :
        LeastSquares(NumTerms,
                     "Polynomial Least Squares Fit", "Poly", Data, OffsetTime)
    {
        DoIt();
    };
...
public:
    Fourier(int NumPoints, float x[], float y[], int NumTerms) :
        LeastSquares(NumPoints, x, y, NumTerms,
                     "Fourier Finite Series Least Squares Fit", "For")
    {
        DoIt();
    };

    Fourier(TLineSeries *Data, bool OffsetTime, int NumTerms) :
        LeastSquares(NumTerms, "Fourier Finite Series Least Squares Fit", "For", Data, OffsetTime)
    {
        DoIt();
    };
...
public:
    Power(int NumPoints, float x[], float y[]) :
        LeastSquares(NumPoints, x, y, 2, "Power Law Least Squares Fit", "Pow")
    {
        DoIt();
    };

    Power(TLineSeries *Data, bool OffsetTime) :
        LeastSquares(2, "Power Law Least Squares Fit", "Pow", Data, OffsetTime)
    {
        DoIt();
    };
...
public:
    Expo(int NumPoints, float x[], float y[]) :
        LeastSquares(NumPoints, x, y, 2, "Exponential Least Squares Fit", "Exp")
    {
        DoIt();
    };

    Expo(TLineSeries *Data, bool OffsetTime) :
        LeastSquares(2, "Exponential Least Squares Fit", "Exp", Data, OffsetTime)
    {
        DoIt();
    };
...
public:
    Log(int NumPoints, float x[], float y[]) :
        LeastSquares(NumPoints, x, y, 2, "Logarithmic Least Squares Fit", "Log")
    {
        DoIt();
    };

    Log(TLineSeries *Data, bool OffsetTime) :
        LeastSquares(2, "Logarithmic Least Squares Fit", "Log", Data, OffsetTime)
    {
        DoIt();
    };
...
public:
    MLinReg(int NumPoints, float x[], float y[], int NumTerms) :
        LeastSquares(NumPoints, x, y, NumTerms, "Multiple Linear Regression", "MLR")
    {
        DoIt();
    };

    MLinReg(TLineSeries *Data, int NumTerms, double **Basis) :
        LeastSquares(NumTerms, "Multiple Linear Regression", "MLR", Data, false), Basis(Basis)
    {
        CopyAndDelete(), DoIt();
    };
...
public:
    User(int NumPoints, float x[], float y[]) :
        LeastSquares(NumPoints, x, y, 2, "User's Fit - currently powers of X", "Use")
    {
        DoIt();
    };

    User(TLineSeries *Data, int NumTerms) :
        LeastSquares(2, "User's Fit - currently powers of X", "Use", Data, OffsetTime)
    {
        DoIt();
    };
