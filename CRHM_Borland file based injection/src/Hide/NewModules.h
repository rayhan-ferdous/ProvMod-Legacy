...
float *areafrac;
float *runofffrac;
float *PCM_runoff_multiplier;
float *total_slough_basin_area;
float *PCM_Sdmax;
float *total_slough_volume;
float *PCM_outflow;
...
const float *p1;
const float *p2;
const float *maxPondArea_p1;
const float *minPondBasinArea;
const float *minPondArea;
const float *basinarea_c1;
const float *basinarea_c2;
const float **Max_V_N;
...
float *basinflow;     // [BASIN] all HRUs
float *basinflow_mWQ;     // [BASIN] all HRUs
float *basinflow_s;   // [BASIN] all HRUs
float *cumbasinflow;  // [BASIN] all HRUs
float *cumbasinflow_mWQ;  // [BASIN] all HRUs
float *basingw;       // [BASIN} all HRUs
float *basingw_mWQ;       // [BASIN} all HRUs
float *basingw_s;     // [BASIN} all HRUs
float *cumbasingw;    // [BASIN} all HRUs
...
void Sub_WQ(long hru, float *var, float *var_cWQ, float *var2, float *var2_cWQ, float *var3, float *var3_cWQ);
void Set_WQ(long hru, float *var, float *var_cWQ, float amount_cWQ, float amount);
