...
using namespace std;
  ...
  namespace CRHM{
    ...
    enum TDim {BASIN, ONE, TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT, NINE, TEN, ELEVEN, TWELVE, NHRU, NOBS, NLAY, NDEF, NFREQ, NREB, NDEFN, DEFX};
    enum TBuild {BUILD, DECL, INIT, RUN};

    enum TTiming {IDLE, EARLY, MELT, MELT2, MATURE, HOLD};
    enum TFun {FOBS, W_MJ, MJ_W, AVG, MIN, MAX, DTOT, POS, TOT, TOT_INT, FIRST, LAST, INTVL};
