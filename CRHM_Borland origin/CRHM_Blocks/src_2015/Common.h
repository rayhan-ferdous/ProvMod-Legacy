...
//    enum TFun {FOBS, VP_SAT, W_MJ, MJ_W, AVG, MIN, MAX, TOT, POS, FIRST, LAST, CNT, CNT0, DLTA, INTVL, DAY, DTOT}; // update whem main updated
    enum TFun {FOBS, VP_SAT, W_MJ, MJ_W, AVG, MIN, MAX, DTOT, POS, TOT, FIRST, LAST, PK, CNT, CNT0, DLTA, INTVL, DAY};
...
string FloatToStrF(float, TFloatFormat, int, int);

string FloatToStrF(double, TFloatFormat, int, int);

string FloatToStrF(long, TFloatFormat, int, int);

string FormatString(double, string);
