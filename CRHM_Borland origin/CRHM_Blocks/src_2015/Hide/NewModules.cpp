...
void MoveModulesToGlobal(string DLLName){
  ...
  DLLModules.AddModule(new Classobs("obs", "11/12/14", CRHM::BASIC));
  ...
  DLLModules.AddModule(new Classpbsm("pbsm", "02/04/15", CRHM::ADVANCE));
  ...
  DLLModules.AddModule(new ClassLongVt("longVt", "05/29/14", CRHM::ADVANCE));
  ...
  DLLModules.AddModule(new ClassevapX("evapX", "12/18/12", CRHM::PROTO));
  DLLModules.AddModule(new ClassevapD("evapD", "11/04/09", CRHM::ADVANCE));
  DLLModules.AddModule(new Classevap_Resist("evap_Resist", "09/27/13", CRHM::ADVANCE));
  ...
  DLLModules.AddModule(new Classfrozen("frozen", "05/16/13", CRHM::ADVANCE));
  DLLModules.AddModule(new ClassfrozenAyers("frozenAyers", "07/15/13", CRHM::ADVANCE));

  DLLModules.AddModule(new ClassSoil("Soil", "01/29/15", CRHM::BASIC));
  DLLModules.AddModule(new ClassNetroute("Netroute", "09/10/13", CRHM::BASIC));
  DLLModules.AddModule(new ClassNetroute_D("Netroute_D", "09/10/13", CRHM::ADVANCE));
  DLLModules.AddModule(new ClassNetroute_M("Netroute_M", "09/10/13", CRHM::ADVANCE));
  DLLModules.AddModule(new ClassNetroute_M_D("Netroute_M_D", "05/15/13", CRHM::ADVANCE));
  ...
  DLLModules.AddModule(new ClassSnobalCRHM("SnobalCRHM", "03/26/15", CRHM::ADVANCE));
  DLLModules.AddModule(new ClasspbsmSnobal("pbsmSnobal", "02/04/15", CRHM::ADVANCE));

  DLLModules.AddModule(new ClassCRHMCanopy("Canopy", "02/05/14", CRHM::ADVANCE));
  DLLModules.AddModule(new ClassCRHMCanopyClearing("CanopyClearing", "02/13/14", CRHM::ADVANCE));
  DLLModules.AddModule(new ClassCRHMCanopyClearingGap("CanopyClearingGap", "03/27/15", CRHM::ADVANCE));
  ...
  DLLModules.AddModule(new ClassVolumetric("Volumetric", "02/06/15", CRHM::ADVANCE));
  ...
  DLLModules.AddModule(new Classqmelt2("Qmelt2", "01/09/15", CRHM::CUSTOM));
  DLLModules.AddModule(new Classquinton2("Quinton2", "01/09/15", CRHM::CUSTOM));

  DLLModules.AddModule(new Classquinton("Quinton", "05/06/05", CRHM::CUSTOM));
  DLLModules.AddModule(new Classqdrift("Qdrift", "02/28/03", CRHM::CUSTOM));
  DLLModules.AddModule(new Classqmelt("Qmelt", "04/10/03", CRHM::CUSTOM));
  ...
  DLLModules.AddModule(new ClassSoilX("SoilX", "01/29/15", CRHM::PROTO));
  DLLModules.AddModule(new ClassSoilK("SoilK", "01/29/15", CRHM::PROTO)); // prototype wetlands
  ...
  DLLModules.AddModule(new ClassSWEslope("SWESlope", "10/01/14", CRHM::PROTO));
  DLLModules.AddModule(new Classlake("lake_evap", "07/04/12", CRHM::PROTO));
  DLLModules.AddModule(new ClassK_Estimate("K_Estimate", "01/23/15", CRHM::PROTO));
  ...
  DLLModules.AddModule(new ClassXG("XG", "04/01/15", CRHM::PROTO));
  DLLModules.AddModule(new Classcontribution("contribution", "01/29/14", CRHM::PROTO));
  DLLModules.AddModule(new ClassPCM("PCM", "06/20/14", CRHM::PROTO));
  DLLModules.AddModule(new ClassTest("Test", "08/25/14", CRHM::PROTO));
  DLLModules.AddModule(new ClassSoilDS("SoilDetention", "01/29/15", CRHM::PROTO));
  ...
  DLLModules.AddModule(new Classglacier_org("glacier_org", "03/23/15", CRHM::OBSOL));
  DLLModules.AddModule(new Classglacier("glacier", "04/14/15", CRHM::PROTO));
  DLLModules.AddModule(new Classglacier2("glacier2", "04/14/15", CRHM::PROTO));
...
void Classobs::decl(void) {
  ...
  decldiagparam("HRU_OBS", NDEFN, "[1, 2, 3!]", "1", "100", "observation indirection tables ([1] - t_rh_ea, [2] - p_ppt, [3] - u, [4] - Q, [5] - misc)", "()", &HRU_OBS, &HRU_OBS_Tables, 5);
  ...
  decldiagparam("Use_Observations_As_Supplied", ONE, "[0]", "0", "1", "0 -> CRHM handles observation corrections for lapse rate/allocation etc., 1 -> Externally corrected observation dataset.", "()", &Use_Observations_As_Supplied);


  if(Global::BuildFlag == CRHM::INIT){ // required here to set up data for ClassModule::ReadObs

    Global::OBS_AS_IS = (Use_Observations_As_Supplied[0]); // applies to all
  ...
  float *deref = const_cast<float *>(p);

  declobsfunc("p", "p",  &deref, FOBS, NULL, true);


  variation_set = VARIATION_0 + VARIATION_1;

  declparam("catchadjust", NHRU, "[0]", "0", "2", "none - 0/Nipher - 1/Geonor - 2", "()", &catchadjust);
...
void Classobs::init(void) {
  ...
  if(Use_Observations_As_Supplied[0]) // applies to all HRUs
    Global::HRU_OBS = const_cast<long **> (Global::HRU_OBS_DIRECT);
  else
...
void Classobs::pre_run(void) {
  ...
  Global::RH_EA_obs = Using_RH_EA_obs;
}
...
void ClassTs::run(void) { // executed every interval
  ...
  for (hh = 0; chkStruct(); ++hh) {
    ...
    Ts[hh] = T1 + (CRHM_constants::emiss*(Qli_[hh] - CRHM_constants::sbc*pow(T1, 4.0f)) + CRHM_constants::Ls*(q - Qs(Pa[hh], T1))*rho/ra[hh])/
...
void Classevap::finish(bool good) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    LogMessageA(hh, string("'" + Name + " (evap)' hru_cum_evap    (mm) (mm*hru) (mm*hru/basin): ").c_str(), cum_evap[hh], hru_area[hh], basin_area[0], s);
  ...
  LogMessage(string("'" + Name + " (evap)' Allcum_evap  (mm*basin): "), Allcum_evap , "*** potential evaporation");
  LogMessage(string("'" + Name + " (evap)' Allcum_actet (mm*basin): "), Allcum_actet, "*** actual evaporation");
  LogDebug(" ");
...
void ClassevapD::finish(bool good) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    string s = "**** " + Evap_names[evap_type[hh]] + " ****";
    LogMessageA(hh, string("'" + Name + " (evapD)' hru_cum_evap  (mm) (mm*hru) (mm*hru/basin): ").c_str(), cum_evap[hh],  hru_area[hh], basin_area[0], s);
...
void Classfrozen::decl(void) {
  ...
  declreadobs("t0_inhibit", NHRU, "opportunity time inhibit", "()", &t0_inhibit, HRU_OBS_misc, true);
}
...
void Classfrozen::run(void) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    infil[hh] = 0.0;
//    runoff[hh] = 0.0;  // not required - always zero
...
void ClassNetroute::finish(bool good) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    LogMessageA(hh, string("'" + Name + " (Netroute)' cum_to_Sd              (mm) (mm*km^2) (mm*basin): ").c_str(), cum_to_Sd[hh]/hru_area[hh], hru_area[hh], basin_area[0], " *** Added to this HRU Sd");
    LogMessageA(hh, string("'" + Name + " (Netroute)' cum_to_soil_rechr      (mm) (mm*km^2) (mm*basin): ").c_str(), cum_to_soil_rechr[hh]/hru_area[hh], hru_area[hh], basin_area[0], " *** Added to this HRU recharge");
...
void ClassSnobalCRHM::decl(void) {
    ...
    declparam("max_z_s_0", NHRU, "[0.1]", "0.0", "0.35", "maximum active layer thickness", "(m)", &max_z_s_0);
    declparam("max_h2o_vol", NHRU, "[0.01]", "0.0001", "0.2", "max liquid h2o content as volume ratio: V_water/(V_snow - V_ice)", "()", &max_h2o_vol);
...
// heights must be positive
	if (z0 <= 0 || zq <= z0 || zu <= z0 || za <= z0) {
                string D = FormatString(Global::DTnow, " yy mm dd hh nn ") + "hle1: height not positive ";
                string SS = D + "hru " + longtoStr(hh+1);
...
// pressures must be positive
	if (ea <= 0 || es <= 0 || press <= 0 || ea >= press || es >= press) {
                ...
                string SS = D + "hh " + longtoStr(hh) +" 'hle1' " + ". H: " + FloatToStrF(h, ffFixed, 10, 4) + " le: " + FloatToStrF(xlh * e, ffFixed, 10, 4);
                SS = SS + " ta: " + FloatToStrF(ta-CRHM_constants::Tm, ffFixed, 10, 4) +
...
// latent heat flux (- away from surf)
  ...
  if(iter >= ITMAX){
    ...
    string D = FormatString(Global::DTnow, " yy mm dd hh nn ");
    string SS = D + "hh " + longtoStr(hh) +" 'hle1' " + Flag + ". H: " + FloatToStrF(h, ffFixed, 10, 4) + " le: " + FloatToStrF(xlh * e, ffFixed, 10, 4);
    SS = SS + " ta: " + FloatToStrF(ta-CRHM_constants::Tm, ffFixed, 10, 4) +
                 ", ts: " + FloatToStrF(ts-CRHM_constants::Tm, ffFixed, 10, 4) +
                 ", ea: " + FloatToStrF(ea, ffFixed, 10, 4) +
                 ", es: " + FloatToStrF(es, ffFixed, 10, 4) +
...
void ClassNetroute_M::init(void) {
  ...
  for(hh = 0; hh < nhru; ++hh){
    if(Ktravel[hh] >= (Global::Interval/(2.0*route_X_M[hh]))){
      string S = string("'" + Name + " (Netroute_M) Muskingum coefficient negative in HRU ").c_str() + longtoStr(hh+1);
      CRHMException TExcept(S.c_str(), WARNING);
      LogError(TExcept);
    }
...
void ClassNetroute_M::finish(bool good) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    LogMessageA(hh, string("'" + Name + " (Netroute_M)' cum_to_Sd              (mm) (mm*km^2) (mm*basin): ").c_str(), cum_to_Sd[hh]/hru_area[hh], hru_area[hh], basin_area[0], " *** Added to this HRU Sd");
    LogMessageA(hh, string("'" + Name + " (Netroute_M)' cum_to_soil_rechr      (mm) (mm*km^2) (mm*basin): ").c_str(), cum_to_soil_rechr[hh]/hru_area[hh], hru_area[hh], basin_area[0], " *** Added to this HRU recharge");
...
ClassMSM* ClassMSM::klone(string name) const{
  return new ClassMSM(name);
}
...
void ClassMSM::decl(void) {
    ...
    declreadobs("Qsi", NHRU, "incident short-wave", "(W/m^2)", &Qsi, HRU_OBS_Q, true);
...
Classquinton2* Classquinton2::klone(string name) const{
  return new Classquinton2(name);
}
...
void Classquinton2::decl(void) {
  ...
  decllocal("Scaling", NHRU, "Handles ratio HRU Area/Length (m) of HRU to adjust input and output flows.", "(m)", &Scaling);


  declparam("order", NHRU, "[1,2,3,4,5!]", "1","1000", "HRU soil routing process order", "()", &order);

  declparam("DrainTo", NHRU, "[0]", "0", "20", " runoff drains to HRU, 0=NOWHERE, otherwise HRU# (1 to MAXHRU)", "()", &DrainTo);

  declparam("Snowmelt_DrainTo", NHRU, "[1,2,3,4,5!]", "0", "20", " snowmelt drains to HRU, 0=NOWHERE, HRU# (1 to MAXHRU)", "()", &DriftDrainTo);
  ...
  declparam("length", NHRU, "[1]", "0", "1E4", "length of slope (normal to creek)", "(m)", &length);
...
void Classquinton2::init(void) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    if(!OK){
        string SS = string("'" + Name + " (Quinton2)' the 'order' parameter does not have a unique value for each HRU");
        CRHMException Except(SS.c_str() ,ERR);
        LogError(Except);
        throw Except;
    }

    Scaling[hh] = hru_area[hh]/length[hh]*10.0E6; // Handles HRUs having different areas and/or lengths
...
// bubbling pressure = 1/alph
    ...
    if(Depth[hh] > 0.0) {
      ...
      float lasttransit = transit[hh];  // !!! check *24 moved

      transit[hh] = length[hh]/kd*24.0; // unit of days

//      if(lasttransit != transit[hh] && flowLag[hh] < 0.0)
//        Delayflow->ChangeLag(transit, hh);               // ******* DANGER fix!
    ...
    for(int hhh = 0; hhh <= hh; ++hhh) { // includes first HRU
      if(DriftDrainTo[hhh]-1 == hh)
        flowin[hh] += melt[hhh]/Scaling[hh]/1000.0; // convert (mm) to (m)
    }

    flowin[hh] += hru_p[hh]/1000; // mm to m ?
    cump[hh] += hru_p[hh];

    for(int hhh = 0; hhh < hh; ++hhh) {
      if(DrainTo[hhh]-1 == hh) {
        flowin[hh] += runoffDly[hhh]*Scaling[hh]; // already (m)
        flowin[hh] += flowDly[hhh]*Scaling[hh]; // already (m)
      }
    }  // for

    d_cum = 0.0; // bottom of layer

    if(flowin[hh] > MINFLOAT*2) {  // infiltrate surface excess water into layers
      ...
      flowin[hh] *= Scaling[hh]; // put back to HRU value
...
//          Bot = layerwater_lay[nn][hh] + capillary_lay[nn][hh];
  ...
  for(hh = 0; chkStruct(); ++hh) {
    cumrunoff[hh] += runoffDly[hh]*Scaling[hh];
    cumflow[hh] += flowDly[hh]*Scaling[hh];
    flowm3Dly[hh] = flowDly[hh]*Scaling[hh];
    runoffm3Dly[hh] = runoffDly[hh]*Scaling[hh];
  }
}
...
void Classquinton2::finish(bool good) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    LogMessageA(hh, "(Hummock) - water_content          (m^3) (m/m^2): ", c*length[hh], length[hh]);
    LogMessageA(hh, "(Hummock) - cumulative_flowin      (m^3) (m/m^2): ", cumflowin[hh]*length[hh], length[hh]);
    LogMessageA(hh, "(Hummock) - cumulative_precip      (m^3) (m/m^2): ", cump[hh]*length[hh]/1000, length[hh]);
    LogMessageA(hh, "(Hummock) - cumulative_flowout     (m^3) (m/m^2): ", cumflow[hh]*length[hh], length[hh]);
    LogMessageA(hh, "(Hummock) - Delayflow_in_storage   (m^3) (m/m^2): ", Delayflow->Left(hh)*length[hh], length[hh]);
    LogMessageA(hh, "(Hummock) - cumulative_runoff      (m^3) (m/m^2): ", cumrunoff[hh]*length[hh], length[hh]);
    LogMessageA(hh, "(Hummock) - Delayrunoff_in_storage (m^3) (m/m^2): ", Delayrunoff->Left(hh)*length[hh], length[hh]);
    LogDebug(" ");
...
Classqmelt2* Classqmelt2::klone(string name) const{
  return new Classqmelt2(name);
}
...
void Classqmelt2::run(void) {
  ...
  if(start) { // calculate daily regression
    ...
    for(hh = 0; chkStruct(); ++hh) {
//      if(hru_tmean[hh] - TIs0Mn[hh] > 0.0 && SWE[hh] <= 0.0)
...
//      else
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    if(hru_t[hh] > TIs0Mn[hh] && SWE[hh] <= 0.0)
      Qg[hh] = (hru_t[hh] - TIs0Mn[hh])*TIs1Mn[hh];  // distribute daily to interval
    else
      Qg[hh] = 0.0;
...
void Classpbsm_M::decl(void) {
  ...
  declvar("Results", NDEFN, "calulated distributions", "()", &Results, &Results_lay);
...
void ClassNetroute_D::finish(bool good) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    LogMessageA(hh, string("'" + Name + " (Netroute_D)' cum_to_Sd              (mm) (mm*km^2) (mm*basin): ").c_str(), cum_to_Sd[hh]/hru_area[hh], hru_area[hh], basin_area[0], " *** Added to this HRU Sd");
    LogMessageA(hh, string("'" + Name + " (Netroute_D)' cum_to_soil_rechr      (mm) (mm*km^2) (mm*basin): ").c_str(), cum_to_soil_rechr[hh]/hru_area[hh], hru_area[hh], basin_area[0], " *** Added to this HRU recharge");
...
void ClassNetroute_M_D::init(void) {
  ...
  for(hh = 0; hh < nhru; ++hh){
    if(Ktravel[hh] >= (Global::Interval/(2.0*route_X_M[hh]))){
      string S = string("'" + Name + " (Netroute_M_D) Muskingum coefficient negative in HRU ").c_str() + longtoStr(hh+1);
      CRHMException TExcept(S.c_str(), WARNING);
      LogError(TExcept);
    }
...
void ClassNetroute_M_D::finish(bool good) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    LogMessageA(hh, string("'" + Name + " (Netroute_M_D)' cum_to_Sd              (mm) (mm*km^2) (mm*basin): ").c_str(), cum_to_Sd[hh]/hru_area[hh], hru_area[hh], basin_area[0], " *** Added to this HRU Sd");
    LogMessageA(hh, string("'" + Name + " (Netroute_M_D)' cum_to_soil_rechr      (mm) (mm*km^2) (mm*basin): ").c_str(), cum_to_soil_rechr[hh]/hru_area[hh], hru_area[hh], basin_area[0], " *** Added to this HRU recharge");
...
void ClassSetSoil::init(void) {
  ...
  if(!(RapidAdvance_to->Strings[0].empty()))
  try{
    Global::RapidAdvanceTo = StrToDate(RapidAdvance_to->Strings[0]);
    if(Loop_to->Count >= 1){
      Global::LoopTo = StrToDate(Loop_to->Strings[0]);
...
void ClassVolumetric::run(void) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    if(nstep == 0 && set_fallstat[hh] == Julian || (getstep() == 1 && Julian > set_fallstat[hh])){
      if(Si){
        float X = Volumetric[hh]/SetSoilproperties[soil_type[hh]][3]*1000.0;
...
// declared variables
  ...
  declstatdiag("cum_SUnload_H2O", NHRU, "Cummulative unloaded canopy snow as water", "(mm)", &cum_SUnload_H2O);
...
// calculate maximum canopy snow load (L*):
  ...
  // calculate intercepted snowload
      ...
      if(hru_snow[hh] > 0.0 && fabs(hru_snow[hh]/LStar) < 50.0){
...
// determine whether canopy snow is unloaded:
      ...
      if(IceBulbT >= unload_t[hh]){
        if(IceBulbT >= unload_t_water[hh]){
          drip_Cpy[hh] = Snow_load[hh];
          SUnload_H2O[hh] = Snow_load[hh];
        }
        else {
...
void ClassfrozenAyers::run(void) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    if(nstep == 0){ // end of day
      ...
      CRHMException TExcept(string(string("Ice lens formed in HRU ") + longtoStr(hh+1) +", at minimum temperature of " + FloatToStrF(hru_tmin[hh], ffGeneral, 4, 1)).c_str(), WARNING);
      LogError(TExcept);
    }
...
void ClassSoil::decl(void) {
  ...
  declvar("culvert_evap", NHRU, "Depth of water evaporating.", "(mm/int)", &culvert_evap);
...
void ClassSoil::init(void) {
  ...
  for(hh = 0; hh < nhru; ++hh) {
    ...
    if(soil_rechr[hh] > soil_moist[hh]) {
      ...
      string S = string("'") + Name + " (Soil)' Soil_rechr greater than soil_moist, soil_rechr set to soil_moist, hru = " + longtoStr(hh).c_str();
      CRHMException TExcept(S.c_str(), WARNING);
      LogError(TExcept);
      throw TExcept;
    }
    ...
    if(soil_rechr_max[hh] > soil_moist_max[hh]) {
      string S = string("'") + Name + " (Soil)' Soil_rechr_max cannot be greater than soil_moist_max in hru = " + longtoStr(hh+1).c_str();
      CRHMException TExcept(S.c_str(), TERMINATE);
      LogError(TExcept);
      throw TExcept;
    }
    ...
    if(Sdinit[hh] > Sdmax[hh]) {
      string S = string("'") + Name + " (Soil)' Initial value of depression storage is greater than the maximum value in hru = " + longtoStr(hh+1).c_str();
...
// calculate flow through culvert
    ...
    if(Sd[hh] > 0.0 && Sd_ssr_K[hh] > 0.0){
      ...
      if(Sd2ssr_k >= Sd[hh])
        Sd2ssr_k = Sd[hh];
      soil_ssr[hh] += (Sd[hh]*Sd2ssr_k);
      Sd[hh] -= (Sd[hh]*Sd2ssr_k);
      if(Sd[hh] < 0.0)
        Sd[hh] = 0.0;
    }
...
void ClassK_Estimate::decl(void) {
  ...
  declparam("hru_GSL",     NHRU, "[0.0]", "0.0", "90.0", "ground slope - increasing the slope positively, tilts the plane to the north with ASL = 0", "(°)", &hru_GSL);
//  declparam("porosity",    NHRU, "[0.5]", "0.0", "1.0", "soil porosity", "(m^3/m^3)", &porosity);
  declparam("PSD",         NHRU, "[0.252]", "0.0", "10.0", "pore size distribution", "()", &PSD);
  declparam("soil_rechr_max", NHRU, "[60.0]", "0.0", "250.0", "Maximum value for soil recharge zone (upper portion of soil_moist where losses occur as both evaporation and transpiration). Must be less than or equal to soil_moist", "(mm)", &soil_rechr_max);
...
//  declparam("gw_max",       NHRU, "[375.0]", "0.0", "5000.0", "Maximum available water holding capacity of ground water profile.", "(mm)", &gw_max);
...
void ClassK_Estimate::run(void) {
  ...
  for(hh = 0; chkStruct(); ++hh){
    ...
    lower_ssr_K[hh] = v_L_lower[hh]*soil_moist_max[hh]*86400;
...
ClassSoilK* ClassSoilK::klone(string name) const{
  return new ClassSoilK(name);
}

void ClassSoilK::decl(void) {

  Description = "'Handles soil moisture throughout the year.' \
                 'Standard version(Soil) with wetlands addition,' \
                 'Version with Culvert limited runoff.'";
  ...
  decldiag("cum_culvert", NHRU, "Cumulative culvert HRU flow", "(m^3)", &cum_culvert);

  decldiag("cum_culvert_over", NHRU, "Cumulative culvert HRU overflow", "(m^3)", &cum_culvert_over);
  ...
  decldiag("cum_redirected_residual", NHRU, "cumulative HRU redirected_residual to another HRU", "(mm*km^2)", &cum_redirected_residual);
  ...
  decldiag("cum_gw_flow", NHRU, "Accumulation of excess soil water from a HRU that enters groundwater reservoirs", "(mm)", &cum_gw_flow);

  declvar("soil_ssr", NHRU, "Portion of soil moisture and recharge excess from a HRU that enters subsurface reservoirs", "(mm/int)", &soil_ssr);

  declvar("rechr_ssr", NHRU, "Portion of excess soil water from a HRU that enters subsurface reservoirs", "(mm/int)", &rechr_ssr);

  decldiag("cum_soil_ssr", NHRU, "Accumulation of soil moisture from a HRU to ssr", "(mm)", &cum_soil_ssr);

  decldiag("cum_rechr_ssr", NHRU, "Accumulation of Portion of excess from a HRU to ssr", "(mm)", &cum_rechr_ssr);

  declvar("soil_ssr_D", NHRU, "Portion of excess soil water from a HRU that enters subsurface reservoirs", "(mm/d)", &soil_ssr_D);

  declvar("soil_runoff", NHRU, "Portion of excess soil water from a HRU to runoff", "(mm/int)", &soil_runoff);

  decldiag("cum_soil_runoff", NHRU, "Accumulation of Portion of excess soil water from a HRU to runoff", "(mm)", &cum_soil_runoff);
...
void ClassSoilK::init(void) {
  ...
  for(hh = 0; hh < nhru; ++hh) {
    ...
    if(Sdmax[hh] > 0.0 && soil_moist_max[hh] > 0.0)
      Sd_water_frac[hh] = area_frac(Sd[hh]/Sdmax[hh]);
    else
...
//  Handle excess to interflow or runoff
    ...
    if(soil_runoff[hh] > 0.0 && Sdmax[hh] > 0.0 && soil_moist_max[hh] > 0.0){ // handle wetlands

      runoff_to_Sd = Sd_add(soil_runoff[hh]);
...
//******Compute actual evapotranspiration
    ...
    if(variation == VARIATION_1 && culvert_water_V[hh] > 0.0 && hru_evap_buf[hh] > 0.0){ // conditions for culvert evaporation
      culvert_pond = culvert_water_V[hh]/(hru_area[hh]*1000.0); // convert m3 to mm over HRU area
      culvert_evapL = hru_evap_PT_buf[hh]*culvert_water_A[hh]/(hru_area[hh]*1e6); // calculate potential evaporation from pond
    ...
    if(Sd[hh] > 0.0 && soil_moist_max[hh] > 0.0 && hru_evap_PT_buf[hh] > 0.0){ // routine updats Sd
      wetlands_evap[hh] = Sd_subtract(hru_evap_PT_buf[hh]);
    ...
    if(variation == VARIATION_1)
      avail_evap -=  hru_evap_buf[hh]*culvert_water_A[hh]/(hru_area[hh]*1e6);
...
//****** et_type = 2 - evaporation + transpiration
  ...
  //******Soil moisture accounting  Remember that soil_rechr[hh] includes soil_moist[hh]
    ...
    if(nstep == 0){ // end of every day
      ...
      if(evapDiv > 1){ // daily value - ready for next day
         hru_evap_buf[hh] = hru_evap[hh]/evapDiv;
         hru_evap_PT_buf[hh] = hru_evap_PT[hh]/evapDiv;
      }
    }
  } // for
}

void ClassSoilK::finish(bool good) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    LogMessageA(hh, string("'" + Name + " (SoilK)' soil_rechr         (mm) (mm*hru) (mm*hru/basin): ").c_str(), soil_rechr[hh], hru_area[hh], basin_area[0], " *** information only - already included in 'soil_moist'.");
    LogMessageA(hh, string("'" + Name + " (SoilK)' soil_rechr_change  (mm) (mm*hru) (mm*hru/basin): ").c_str(), soil_rechr[hh] - soil_rechr_Init[hh], hru_area[hh], basin_area[0], " *** information only - already included in 'soil_moist'.");
    LogMessageA(hh, string("'" + Name + " (SoilK)' soil_moist         (mm) (mm*hru) (mm*hru/basin): ").c_str(), soil_moist[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' soil_moist_change  (mm) (mm*hru) (mm*hru/basin): ").c_str(), soil_moist[hh] - soil_moist_Init[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' hru_cum_actet      (mm) (mm*hru) (mm*hru/basin): ").c_str(), hru_cum_actet[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' cum_hru_condense   (mm) (mm*hru) (mm*hru/basin): ").c_str(), cum_hru_condense[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' cum_infil_act(all) (mm) (mm*hru) (mm*hru/basin): ").c_str(), cum_infil_act[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' cum_soil_gw        (mm) (mm*hru) (mm*hru/basin): ").c_str(), cum_soil_gw[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' cum_soil_runoff    (mm) (mm*hru) (mm*hru/basin): ").c_str(), cum_soil_runoff[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' cum_rechr_ssr      (mm) (mm*hru) (mm*hru/basin): ").c_str(), cum_rechr_ssr[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' cum_soil_ssr       (mm) (mm*hru) (mm*hru/basin): ").c_str(), cum_soil_ssr[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' Sd                 (mm) (mm*hru) (mm*hru/basin): ").c_str(), Sd[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' Sd_change          (mm) (mm*hru) (mm*hru/basin): ").c_str(), Sd[hh] - Sd_Init[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' cum_runoff_to_Sd   (mm) (mm*hru) (mm*hru/basin): ").c_str(), cum_runoff_to_Sd[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' gw                 (mm) (mm*hru) (mm*hru/basin): ").c_str(), gw[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' gw_change          (mm) (mm*hru) (mm*hru/basin): ").c_str(), gw[hh] - gw_Init[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SoilK)' cum_gw_flow        (mm) (mm*hru) (mm*hru/basin): ").c_str(), cum_gw_flow[hh], hru_area[hh], basin_area[0]);
    LogDebug(" ");
    LogMessageA(hh, string("'" + Name + " (SoilK)' cum_redirected_residual (mm) (mm*hru) (mm*hru/basin): ").c_str(), cum_redirected_residual[hh]/hru_area[hh], hru_area[hh], basin_area[0], " *** Added to this HRU surface runoff");
    LogDebug(" ");

    if(variation == VARIATION_1){
      LogMessageA(hh, string("'" + Name + " (SoilK)' cum_culvert      (m3) (m3*hru) (m3*hru/basin): ").c_str(), cum_culvert[hh], hru_area[hh], basin_area[0]);
      LogMessageA(hh, string("'" + Name + " (SoilK)' cum_culvert_over (m3) (m3*hru) (m3*hru/basin): ").c_str(), cum_culvert_over[hh], hru_area[hh], basin_area[0]);
      LogDebug(" ");
    }
  ...
  LogMessage(string("'" + Name + " (SoilK)' Allcum_soil_runoff (mm*basin): ").c_str(), Allcum_soil_runoff);
  LogMessage(string("'" + Name + " (SoilK)' Allcum_soil_ssr (mm*basin): ").c_str(), Allcum_soil_ssr);
  LogMessage(string("'" + Name + " (SoilK)' Allcum_rechr_ssr (mm*basin): ").c_str(), Allcum_rechr_ssr);
  LogMessage(string("'" + Name + " (SoilK)' Allcum_soil_gw (mm*basin): ").c_str(), Allcum_soil_gw);
  LogMessage(string("'" + Name + " (SoilK)' Allcum_gw_flow (mm*basin): ").c_str(), Allcum_gw_flow);
  LogMessage(string("'" + Name + " (SoilK)' Allcum_infil_act (mm*basin): ").c_str(), Allcum_infil_act);
  LogMessage(string("'" + Name + " (SoilK)' Allcum_soil_moist_change (mm*basin): ").c_str(), Allcum_soil_moist_change);
  LogMessage(string("'" + Name + " (SoilK)' Allcum_Sd_change (mm*basin): ").c_str(), Allcum_Sd_change);
  LogMessage(string("'" + Name + " (SoilK)' Allcum_gw_change (mm*basin): ").c_str(), Allcum_gw_change);
  LogDebug(" ");
}

float ClassSoilK::contrib_frac_add(const float contrib_frac_slice, const float delta_Sd){
...
float ClassSoilK::Sd_add(const float applied_depth){
...
// adds water to Sd
  ...
  contrib_frac_new = contrib_frac_add(contrib_frac[hh], delta_Sd);
  ...
  if (contrib_frac_error < tolerance){
    ...
    contrib_frac_slice =  contrib_frac[hh];
     ...
     for (long ii = 0; ii < slices; ++ii){
       ...
       delta_volfrac = delta_Sd / Sdmax[hh];
       contrib_frac_slice = contrib_frac_add(contrib_frac_slice, delta_Sd);
     }
...
float ClassSoilK::Sd_subtract(const float applied_depth){

//  subtracts depth of water from Sd
  ...
  water_area_frac_new = area_frac((Sd[hh] - delta_Sd)/ Sdmax[hh]);
  ...
  if (water_area_frac_error < tolerance){ //  check to see if potential change in contrib_fraction warrants use of numerical integration
    ...
    water_area_frac_slice =  Sd_water_frac[hh];
     ...
     for (long ii = 0; ii < slices; ++ii){
       ...
       water_area_frac_slice = area_frac(volfrac);
     }
  }
// update state variables
  ...
  Sd_water_frac[hh] = area_frac(Sd[hh]/Sdmax[hh]);
  contrib_frac[hh] = contrib_frac_subtract();
...
float ClassSoilK::area_frac(const float vol_frac){
...
float ClassSoilK::contrib_frac_subtract(void){
...
void Classglacier::decl(void) {
  ...
  declstatdiag("cumSWEmelt", NHRU, "cummulative SWE snowmelt", "(mm)", &cumSWEmelt);
  ...
  declstatdiag("cumfirnmelt", NHRU, "cummulative firn melt", "(mm)", &cumfirnmelt);

  declvar("icemelt", NHRU, "daily ice melt", "(mm/d)", &icemelt);

  declvar("icemelt_delayed", NHRU, "daily ice melt delayed", "(mm/d)", &icemelt_delayed);

  declstatdiag("cumicemelt", NHRU, "cummulative ice melt", "(mm)", &cumicemelt);

  declvar("infil", NHRU, "snow and ice melt redirected to infiltration.", "(mm/d)", &infil);

  decldiag("cuminfil", NHRU, "cummulative snow and ice melt redirected to infiltration.", "(mm)", &cuminfil);

  declvar("snowinfil", NHRU, "not used. Satisfies module 'Netroute etc.", "(mm/d)", &snowinfil);

  declvar("meltrunoff", NHRU, "snow melt runoff", "(mm/d)", &meltrunoff);

  declstatdiag("cummeltrunoff", NHRU, "cumulative snow melt runoff", "(mm)", &cummeltrunoff);

  declvar("runoff", NHRU, "firn and ice melt runoff", "(mm/d)", &runoff);

  declstatdiag("cumrunoff", NHRU, "cummulative firn and ice melt runoff", "(mm)", &cumrunoff);

  declvar("firn_dens", NDEFN, "densities of snow densification layers", "(kg/m^3)", &firn_dens, &firn_dens_array, Global::nlay);

  declvar("firn_h", NDEFN, "depths of snow densification layers", "(m)", &firn_h, &firn_h_array, Global::nlay);

  declvar("firn_yr", NDEFN, "layer[1] - years to 'critical density] and layer[2, ...] age of firn", "(yr)", &firn_yr, &firn_yr_array, Global::nlay);
  ...
  declvar("firn_init", NHRU, "initial water equivalent of all firn layers", "(m)", &firn_init);

  decldiag("nfirn", NHRU, "num of layers used in firn consolidation array", "()", &nfirn);
  ...
  declstatdiag("cumSWE_2firn", NHRU, "cummulative SWE added to firn", "(mm)", &cumSWE_2firn);

  declvar("Gnet_rainD", NHRU, "daily net rain", "(mm/d)", &net_rainD);
  ...
  declparam("ice_init", NHRU, "[1.0]", "0.0", "1.0E6", "Initial water equivalent of glacier ice", "(m)", &ice_init);
  ...
  declparam("TKMA", NHRU, "[30]", "-50", "50", "Annual mean annual temperature of glacier", "(ºC)", &TKMA);

  declparam("SWEAA", NHRU, "[0.3]", "0.1", "10.0", "Annual mean accumulation of glacier SWE", "(m/yr)", &SWEAA);

  declparam("rho0", NHRU, "[500]", "100.0", "700.0", "zero depth intersection of ln(rho/(rhoice-rho)) could equal average density over first one or two meters of snow.", "(kg/m^3)", &rho0);
  ...
  declparam("firnstorage", NHRU, "[0.0]", "0.0","200.0", "firn storage constant", "(d)", &firnstorage);

  declparam("firnLag", NHRU, "[0.0]", "0.0","1.0E4.0", "firn  lag delay", "(h)", &firnLag);

  declparam("icestorage", NHRU, "[0.0]", "0.0","200.0", "ice melt storage constant", "(d)", &icestorage);

  declparam("iceLag", NHRU, "[0.0]", "0.0","1.0E4.0", "ice melt lag delay", "(h)", &iceLag);

  declparam("SWE_to_infil_K", NHRU, "[0.0]", "0.", "1.0", "daily fraction of snow melt to infiltration.", "()", &SWE_to_infil_K);

  declparam("firn_to_infil_K", NHRU, "[0.0]", "0.", "1.0", "daily fraction of firn melt to infiltration.", "()", &firn_to_infil_K);

  declparam("ice_to_infil_K", NHRU, "[0.0]", "0.", "1.0", "daily fraction of ice melt to infiltration.", "()", &ice_to_infil_K);

  declparam("rain_to_infil_K", NHRU, "[0.0]", "0.", "1.0", "daily fraction of rainfall to infiltration.", "()", &rain_to_infil_K);
...
void Classglacier::init(void) {
  ...
  if(nlay < 2) {
    string S = string("'") + Name + " (glacier)' project file nlay(number of layers) must be greater than 1";
    CRHMException TExcept(S.c_str(), TERMINATE);
    LogError(TExcept);
    throw TExcept;
  }
  ...
  for(hh = 0; hh < nhru; ++hh) {
    ...
    ice[hh] = ice_init[hh]*1000.0;
    meltrunoff[hh] = 0.0;
    runoff[hh] = 0.0;
    snowinfil[hh] = 0.0; // only to satisfy Netroute* linking
    infil[hh] = 0.0;
    ...
    for(long ll = 0; ll < nlay; ++ll) {
      ...
      if(firn_h_array_init[ll][hh] > 0.0){
        if(end_para && !Warned){
          string S = string("'") + Name + " (glacier)' firn initialisation parameters not contiguous in hru = " + longtoStr(hh+1).c_str();
          CRHMException TExcept(S.c_str(), WARNING);
          LogError(TExcept);
          Warned = true;
        }
        ...
        firn_h_array[ll][hh] = firn_h_array_init[ll][hh];
        firn_dens_array[ll][hh] = firn_dens_array_init[ll][hh];
        firn_init[hh] += firn_h_array[ll][hh]*firn_dens_array[ll][hh];
        firn_depth[hh] += firn_h_array[ll][hh];

        firn[hh] += firn_h_array[ll][hh]*firn_dens_array[ll][hh];
      }
      else
        end_para = true;
    }
    ...
    if(nfirn[hh] >= nlay){
      string S = string("'") + Name + " (glacier)' global 'nlay'  must be greater than number of firn layers in hru = " + longtoStr(hh+1).c_str();
      CRHMException TExcept(S.c_str(), TERMINATE);
      LogError(TExcept);
    }
...
void Classglacier::run(void) {
  ...
  if(nstep == 0 || Global::Freq == 1){ // end of every day
    ...
    for(hh = 0; chkStruct(); ++hh) {
      ...
      Qmelt[hh] = 0.0;
      SWEmelt[hh] = snowmeltD[hh]; // SWE melt from Snobal
...
// calculate SWE of firn

      firn[hh] = 0.0;
      for(long nn = 0; nn < nfirn[hh]; ++nn){
        firn[hh] += firn_h_array[nn][hh]*firn_dens_array[nn][hh];
      }
          ...
          switch (variation) {
            case VARIATION_ORG :
              if(QnD != NULL && Use_QnD[hh]){ // observation available (MJ/m^2*d)
                ...
                float Alb = firn_Albedo[hh];
                if(firn[hh] <= 0.0)
                  Alb = ice_Albedo[hh];
                Qn_ebsm[hh] = -0.53+0.47*(QdroD[hh] + QdfoD[hh])*(0.52+0.52*sunact[hh]/sunmax[hh])*(1.0 - Alb);
              }
              break;
            case VARIATION_1 :
              Qn_ebsm[hh] = Qnsn_Acc[hh]*0.0864/Global::Freq; // convert to (MJ/m^2*d)
      ...
      if(firn[hh] > 0.0 || ice[hh] > 0.0){
        ...
        if(nfirn[hh] > 0.0 && Qmelt[hh] > 0.0){ // melt firn
          long lay = 0;
          float h2o;
          while(nfirn[hh] > 0 && Qmelt[hh] > 0.0){
            h2o = firn_dens_array[lay][hh]*firn_h_array[lay][hh];
            if(Qmelt[hh] >= h2o){ // melt firn layer
              firnmelt[hh] += h2o;
              Qmelt[hh] -= h2o;

              while(firn_h_array[lay+1][hh] > 0.0 && lay < nfirn[hh]-1){ // shift firn layers up
                firn_dens_array[lay][hh] = firn_dens_array[lay+1][hh];
                firn_h_array[lay][hh] = firn_h_array[lay+1][hh];
                ++lay;
              } // end while

              firn_h_array[lay][hh] = 0.0;
              --nfirn[hh];
              lay = 0;
            }
            else{ // melt some firn
              h2o -= Qmelt[hh];
              firn_h_array[lay][hh] = h2o/firn_dens_array[lay][hh];
...
// Check if bottom layer of firn becomes ice
          if(nfirn[hh] && firn_dens_array[nfirn[hh] - 1][hh] >= 800.0){ // transfer
            ice[hh] += firn_dens_array[nfirn[hh] - 1][hh] * firn_h_array[nfirn[hh] - 1][hh];
            firn_dens_array[nfirn[hh] - 1][hh] = 0.0;
            firn_h_array[nfirn[hh] - 1][hh] = 0.0;
            --nfirn[hh];
          }
...
// Add new SWE
          ...
          if(SWE[hh] > 0.0){
            if(nfirn[hh] == nlay-1){ // combine last two entries
            ...
            for(long nn = nfirn[hh]; nn >= 0; --nn){ // move column down opening space
              firn_dens_array[nn+1][hh] = firn_dens_array[nn][hh];
              firn_h_array[nn+1][hh] = firn_h_array[nn][hh];
            }

            if(nfirn[hh] >= nlay){ // space available to allocate layer
              string S = string("'") + Name + " (glacier)' too many firn fronts in hru = " + longtoStr(hh+1).c_str();
              CRHMException TExcept(S.c_str(), TERMINATE);
              LogError(TExcept);
              throw TExcept;
            }
...
// Update firn layer densities
          ...
          firn_depth[hh] = firn_h_array[0][hh];

          for(long nn = 1; nn < nfirn[hh]; ++nn){
            float old_firn = firn_dens_array[nn][hh]*firn_h_array[nn][hh];
            float h550 = 1000.0/(RHOi*k0)*(log(550.0/(RHOi - 550.0)) - log(rho0[hh]/(RHOi - rho0[hh]))); // rho0 is zero-depth intersection "value" ???

            if(firn_dens_array[nn][hh] < 550.0){ // density < 550
              float Z0 = exp(RHOi*k0*firn_depth[hh]/1000.0 + log(firn_dens_array[nn][hh]/(RHOi - firn_dens_array[nn][hh])));
              firn_dens_array[nn][hh] = RHOi*Z0/(1.0 + Z0);
              firn_h_array[nn][hh] = old_firn/firn_dens_array[nn][hh];
              firn_yr_array[nn][hh] = 1.0/(k0*SWEAA[hh])*log((RHOi - rho0[hh])/(RHOi - 550));
            }
            else{ // density >= 550
              float Z1 = exp(RHOi*k1*(firn_depth[hh] - h550)/1000.0/sqrt(SWEAA[hh]) + log(550.0/(RHOi - 550.0)));
              firn_dens_array[nn][hh] = RHOi*Z1/(1.0 + Z1);
              firn_h_array[nn][hh] = old_firn/firn_dens_array[nn][hh];
              float t550 = 1.0/(k0*SWEAA[hh])*(log((RHOi - rho0[hh])/(RHOi - 550))); // units years
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    if(SWE_to_infil_K[hh] > 0.0 && SWEmelt_delayed[hh] > 0.0){
      float temp = (1.0 - SWE_to_infil_K[hh])*SWEmelt_delayed[hh];
      meltrunoff[hh] += temp;
      infil[hh] += SWEmelt_delayed[hh] - temp;
    }
    else
      meltrunoff[hh] += SWEmelt_delayed[hh];

    if(firn_to_infil_K[hh] > 0.0 && firnmelt_delayed[hh] > 0.0){
      float temp = (1.0 - firn_to_infil_K[hh])*firnmelt_delayed[hh];
      runoff[hh] += temp;
      infil[hh] += firnmelt_delayed[hh] - temp;
    }
    else
      runoff[hh] += firnmelt_delayed[hh];

    if(ice_to_infil_K[hh] > 0.0 && icemelt_delayed[hh] > 0.0){
      float temp = (1.0 - ice_to_infil_K[hh])*icemelt_delayed[hh];
      runoff[hh] += temp;
      infil[hh] += icemelt_delayed[hh] - temp;
    }
    else
      runoff[hh] += icemelt_delayed[hh];

    if(rain_to_infil_K[hh] > 0.0 && net_rain[hh] > 0.0){
      float temp = (1.0 - rain_to_infil_K[hh])*net_rain[hh];
      runoff[hh] += temp;
      infil[hh] += net_rain[hh] - temp;
    }
    else
      runoff[hh] += net_rain[hh];

    cummeltrunoff[hh] += meltrunoff[hh]; // delayed from previous interval
    cumrunoff[hh] += runoff[hh]; // delayed from previous interval
    cuminfil[hh] += infil[hh]; // delayed from previous interval
...
void Classglacier::finish(bool good) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    LogMessageA(hh, string("'" + Name + " (glacier)' SWE          (mm) (mm*hru) (mm*hru/basin): ").c_str(), SWE[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier)' cumSWEmelt   (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumSWEmelt[hh], hru_area[hh], basin_area[0]);
    ...
    LogMessageA(hh, string("'" + Name + " (glacier)' ice_change  (m) (mm*hru) (mm*hru/basin): ").c_str(), ice_init[hh]*1000.0 - ice[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier)' cummeltrunoff   (mm) (mm*hru) (mm*hru/basin): ").c_str(), cummeltrunoff[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier)' cumrunoff    (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumrunoff[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier)' cuminfil    (mm) (mm*hru) (mm*hru/basin): ").c_str(), cuminfil[hh], hru_area[hh], basin_area[0]);
    LogDebug(" ");
  }
  delete SWEDelay;
  delete firnDelay;
...
void ClassXG::decl(void) {
  ...
  Description = "'A Simple Thaw-Freeze Algorithm (Changwei, 2013).' \
                 ...
                 'using variable air temperature hru_t (°C) and handles the thermal coductivity of the snowpack derived from SWE,' \
                 'using variable air temperature hru_t (°C) and uses parameter n_factor to estimate surface temperature from the air temperature.'";
  ...
  declvar("Zd_front", NDEFN, "freezing/thawing fronts", "(m)", &Zd_front, &Zd_front_array, Global::nlay);

  declvar("Zdf", NHRU, "active freezing front", "(m)", &Zdf);

  declvar("Zdt", NHRU, "active thawing front", "(m)", &Zdt);

  declvar("Th_low_lay", NHRU, "lowest thawed layer", "()", &Th_low_lay);

  declvar("Fz_low_lay", NHRU, "lowest frozen layer", "()", &Fz_low_lay);

  declvar("nfront", NHRU, "number of freezing/thawing fronts", "()", &nfront);

  declvar("Zpf", NHRU, "depth of permafrost", "(m)", &Zpf); // not implemented

  declvar("Bfr", NHRU, "freeze degree days", "(ºC*d)", &Bfr);

  declvar("Bth", NHRU, "thaw degree days", "(ºC*d)", &Bth);

  declvar("pf", NDEFN, "freezing ratios", "()", &pf, &pf_lay, Global::nlay);

  declvar("pt", NDEFN, "thawing ratios", "()", &pt, &pt_lay, Global::nlay);

  declvar("ttc", NDEFN, "thawing thermal conductivity", "(W/(m*K)", &ttc, &ttc_lay, Global::nlay);

  declvar("ftc", NDEFN, "freezing thermal conductivity", "(W/(m*K)", &ftc, &ftc_lay, Global::nlay);
  ...
  declparam("N_Soil_layers", NHRU, "[2]", "1", "10", "number of soil layers. Must be less than or equal nlay. Define Parameters for layers used. All others are ignored", "()", &N_Soil_layers);

  declparam("depths", NDEFN, "[0.5]", "0.0", "10.0", "depths of soil layers", "(m)", &depths, &depths_lay, Global::nlay);

  declparam("por", NDEFN, "[0.5]", "0.0", "1.0", "porosity", "(m^3/m^3)", &por, &por_lay, Global::nlay);

  declparam("theta", NDEFN, "[0.5]", "0.0", "1.0", "degree of saturation (volumetric water content)", "(m^3/m^3)", &theta, &theta_lay, Global::nlay);

  declparam("soil_solid_km", NDEFN, "[2.5]", "0.03", "4", "HRU soil solids thermal conductivity. Suggested values for mineral and loam are 2.5 and 0.06.", "(W/(m*K)", &soil_solid_km, &soil_solid_km_lay, Global::nlay);

  declparam("Zdf_init", NHRU, "[0]", "0.0", "2.5", "initial depth of freezing front", "(m)", &Zdf_init);

  declparam("Zdt_init", NHRU, "[0]", "0.0", "2.5", "initial depth of thawing front. Only applies when Zdf has reached its maximum. Otherwise is 0.0.", "(m)", &Zdt_init);

  declparam("inhibit_kw_ki_update", NHRU, "[0]", "0", "1", "Change thermal conductivities kw/ki behind freezing/thawing front.", "()", &inhibit_kw_ki_update);

  declparam("Option_Kurylyk_Xie", NHRU, "[0]", "0", "1", "Use Kurylyk = 0, Xie_org  - 1", "()", &Option_Kurylyk_Xie);
  ...
  declvar("SWE_density", NHRU, "average density of SWE", "(kg/m^3)", &SWE_density);

  decllocal("SWE_Bfr", NHRU, "thaw degree days for snowpack", "(ºC*d)", &SWE_Bfr);

  decllocal("SWE_Za", NHRU, "physical depth of snowpack", "(m)", &SWE_Za);
  ...
  declparam("n_factor", NHRU, "[1]", "0", "1.2", "n_factor, a constant ratio of surface to air temperature.", "()", &n_factor);
...
void ClassXG::init(void) {
  ...
  front_size = nlay - 1; // first two locations used by active Zdf and Zdt. Last location always 0.0, i.e. end of stack

  if(front_size < 3){
    CRHMException TExcept("number of layers (nlay) should 4 or greater to give 3 or more fronts.", TERMINATE);
    LogError(TExcept);
  }
  ...
  for(hh = 0; hh < nhru; ++hh) {
    ...
    for(long ll = 0; ll < nlay; ++ll) {
      ...
      if(EndofProfile){
        ...
        h2o_lay[ll][hh] = theta_lay[ll][hh]*por_lay[ll][hh]; // water fraction

        ftc_lay[ll][hh] = (1.0 - por_lay[ll][hh])*soil_solid_km_lay[ll][hh] + h2o_lay[ll][hh]*kw + (por_lay[ll][hh] - h2o_lay[ll][hh])*ka;
        ttc_lay[ll][hh] = (1.0 - por_lay[ll][hh])*soil_solid_km_lay[ll][hh] + h2o_lay[ll][hh]*ki + (por_lay[ll][hh] - h2o_lay[ll][hh])*ka;
        h2o_lay[ll][hh] *= 1000.0; // water kg/m3
      }
    }
    ...
    if(variation == VARIATION_1){ //  handle snowcover
      SWE_Bfr[hh] = 0.0;
      SWE_Za[hh] = 0.0;
    }
...
void ClassXG::run(void) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    switch (Option_Kurylyk_Xie[hh]){
      case 0:
        pthaw = &ClassXG::thaw_K;
        break;
      case 1:
        pthaw = &ClassXG::thaw_org;
        break;
    } // switch

    if(variation == VARIATION_ORG)
      B[hh] += hru_tsf[hh]/Global::Freq; // use hru_tsf scaled to daily
    else if(variation == VARIATION_1)
      B[hh] += hru_t[hh]/Global::Freq; // use hru_t scaled to daily
    else // VARIATION_2
      B[hh] += hru_t[hh]*n_factor[hh]/Global::Freq; // use hru_t scaled to daily
...
// Enter freeze or thaw from idle
      ...
      if(TrigAcc[hh] >= Trigthrhld[hh]/2.0 && TrigState[hh] == 0 && (Zdf[hh] > 0.0 || nfront[hh])){ // thaw
          ...
          if(!inhibit_kw_ki_update[hh]){
            for(long ll = 0; ll < N_Soil_layers[hh]; ++ll) // restore initial frozen conductivity values
              ttc_lay[ll][hh] = (1.0 - por_lay[ll][hh])*soil_solid_km_lay[ll][hh] + h2o_lay[ll][hh]*ki/1000.0 + (por_lay[ll][hh] - h2o_lay[ll][hh])*ka/1000.0;

            for(long ll = 1; ll < N_Soil_layers[hh]; ++ll) // restore initial frozen values
      ...
      if(TrigAcc[hh] <= -Trigthrhld[hh]/2.0 && TrigState[hh] == 0){ // freeze    && SWE[hh] > 5.0
          TrigState[hh] = -1;

          Zd_front_array[1][hh] = Zdt[hh];

          if(!inhibit_kw_ki_update[hh]){
            for(long ll = 0; ll < N_Soil_layers[hh]; ++ll) // restore initial thaw conductivity values
              ftc_lay[ll][hh] = (1.0 - por_lay[ll][hh])*soil_solid_km_lay[ll][hh] + h2o_lay[ll][hh]*kw/1000.0 + (por_lay[ll][hh] - h2o_lay[ll][hh])*ka/1000.0;

            for(long ll = 1; ll < N_Soil_layers[hh]; ++ll) // restore initial thaw values
              pf_lay[ll][hh] = sqrt(ftc_lay[ll-1][hh]*h2o_lay[ll][hh]/(ftc_lay[ll][hh]*h2o_lay[ll-1][hh])); // water kg/m3
...
// Goto idle from freeze or thaw
      ...
      if(TrigState[hh] == -1 && TrigAcc[hh] >= Trigthrhld[hh]/2.0){ // changing state from freeze
        TrigState[hh] = 0;
      ...
      if(TrigState[hh] == 1 && TrigAcc[hh] <= -Trigthrhld[hh]/2.0){ // changing state from thaw
        TrigState[hh] = 0;
...
// check for thaw front
            ...
            if(nfront[hh] > 0){
              ...
              if(Last < 0.0){ // frozen front
                ...
                if(Last > 0.0){ // thaw front
                  ...
                  CRHMException TExcept("ClassXG: never two frozen layers together", TERMINATE);
                  LogError(TExcept);
               }
                else{ // no thaw front
                  Zdt[hh] = 0.0;
        ...
        if(Bth[hh] <= 0.0){
          ...
          (this->*pthaw)(); // XG-Algorithm - Thawing
...
void ClassXG::freeze(void) { // XG-Algorithm - Freezing
    ...
    if(variation == VARIATION_1){  //  handle snowcover
      if(SWE[hh] <= 0.0 && SWE_Za[hh] < 0.0){ // One-shot
        SWE_Za[hh] = 0.0;
        Bfr[hh] -= SWE_Bfr[hh];
        if(Bfr[hh] < 0.0){
          Za = 0.0;
          ...
          Za = sqrt(2*86400*ftc_lay[lay-1][hh]*Bfr[hh]/(h2o_lay[lay-1][hh]*L));

        SWE_Bfr[hh] = Bfr[hh];
        SWE_Za[hh] = 0.0;
      }
      else{
        SWE_density[hh] = SWE_to_rho(SWE[hh])*2.0;
        if(SWE_density[hh] > 156.0) // Matthew et al. 1997. The thermal conductivity of seasonal snow
          SWE_tc[hh] = 0.138 - 1.01*SWE_density[hh]/1000.0 + 3.233*sqr(SWE_density[hh]/1000.0);
        else
          SWE_tc[hh] = 0.023 + 0.234*SWE_density[hh]/1000.0;

        float Zsnow = SWE[hh]/SWE_density[hh]; // (m)
        float Zsnow_SWE_Bfr = sqr(depths_lay[lay-1][hh])*SWE_density[hh]*L/(2*86400*SWE_tc[hh]);

        Za = sqrt(2*86400*SWE_tc[hh]*Bfr[hh]/(SWE_density[hh]*L));
        ...
        if(Za <= 0.0){
          ...
          pf_lay[0][hh] = sqrt(SWE_tc[hh]*h2o_lay[1][hh]/(ftc_lay[1][hh]*SWE_density[hh]));
          Za = (Za - SWE[hh]/1000.0)/pf_lay[0][hh];
          SWE_Bfr[hh] = Zsnow_SWE_Bfr;
        }
      }
    }
    else // snowcover already handled
      Za = sqrt(2*86400*ftc_lay[lay-1][hh]*Bfr[hh]/(h2o_lay[lay-1][hh]*L));
    ...
    while(Za > depths_lay[lay-1][hh] && lay < N_Soil_layers[hh]){
      ...
      ++lay;
      if(!inhibit_kw_ki_update[hh] && lay > Fz_low_lay[hh]){
        ftc_lay[Fz_low_lay[hh]-1][hh] = (1.0 - por_lay[Fz_low_lay[hh]-1][hh])*soil_solid_km_lay[Fz_low_lay[hh]-1][hh] + h2o_lay[Fz_low_lay[hh]-1][hh]*ki/1000.0 + (por_lay[Fz_low_lay[hh]-1][hh] - h2o_lay[Fz_low_lay[hh]-1][hh])*ka/1000.0;
...
void ClassXG::thaw_org(void) { // XG-Algorithm - Thawing
    ...
    Za = sqrt(2*86400*ttc_lay[lay-1][hh]*Bth[hh]/(h2o_lay[lay-1][hh]*L)); //Stefan Equation
    ...
    while(Za > depths_lay[lay-1][hh] && lay < N_Soil_layers[hh]){
      ...
      ++lay;
      if(!inhibit_kw_ki_update[hh] && lay > Th_low_lay[hh]){
        ttc_lay[Th_low_lay[hh]-1][hh] = (1.0 - por_lay[Th_low_lay[hh]-1][hh])*soil_solid_km_lay[Th_low_lay[hh]-1][hh] + h2o_lay[Th_low_lay[hh]-1][hh]*kw/1000.0 +
          (por_lay[Th_low_lay[hh]-1][hh] - h2o_lay[Th_low_lay[hh]-1][hh])*ka/1000.0;
...
void ClassXG::thaw_K(void) { // XG-Algorithm - Thawing
    ...
    while(Za > depths_lay[lay-1][hh] && lay < N_Soil_layers[hh]){
      ...
      float a = depths_lay[lay-1][hh]*ttc_lay[lay][hh]/ttc_lay[lay-1][hh];
      float b = sqr(depths_lay[lay-1][hh])*sqr(ttc_lay[lay][hh])/sqr(ttc_lay[lay-1][hh]);
      float c = 2*86400*ttc_lay[lay][hh]*Bth[hh]/(h2o_lay[lay][hh]*L);
      float d = sqr(depths_lay[lay-1][hh])/sqr(pt_lay[lay][hh]);
      float e = sqrt(b + c - d);

      Za = Za - a; // + e;
      ++lay;
      if(!inhibit_kw_ki_update[hh] && lay > Th_low_lay[hh]){
        ttc_lay[Th_low_lay[hh]-1][hh] = (1.0 - por_lay[Th_low_lay[hh]-1][hh])*soil_solid_km_lay[Th_low_lay[hh]-1][hh] +
          h2o_lay[Th_low_lay[hh]-1][hh]*kw/1000.0 +
          (por_lay[Th_low_lay[hh]-1][hh] - h2o_lay[Th_low_lay[hh]-1][hh])*ka/1000.0;
        pt_lay[Th_low_lay[hh]][hh] = sqrt(ttc_lay[Th_low_lay[hh]-1][hh]*h2o_lay[Th_low_lay[hh]][hh]/
          (ttc_lay[Th_low_lay[hh]][hh]*h2o_lay[Th_low_lay[hh]-1][hh]));
        Th_low_lay[hh] = lay;
...
// solve for Bth from Zdt using Bisection method
  ...
  long Cnt = 0;
  float B1 = 0.0, B2 = 50000.0, e;
  do {
    ++Cnt;
    Bth[hh] = (B1 + B2)/2.0;
    (this->*pthaw)(); // calculates Zdt for this value of Bfr
  ...
  } while(fabs(e) > 0.01 && Cnt <= 100);

  if(Cnt >= 100){
    string S = string("'") + Name + " (XG)' Zdt too large in hru = " + longtoStr(hh+1);
    CRHMException TExcept(S.c_str(), TERMINATE);
    LogError(TExcept);
    throw TExcept;
  }
...
// solve for Bfr from Zdt using Bisection method
  ...
  do {
    ++Cnt;
    Bfr[hh] = (B1 + B2)/2.0;
    freeze(); // calculates Zdt for this value of Bfr
    e = Zdf[hh] - df;
    if(e < 0)
      B1 += (B2 - B1)/2.0;
    else
  ...
  if(Cnt >= 100){
    string S = string("'") + Name + " (XG)' Zdf too large in hru = " + longtoStr(hh+1).c_str();
    CRHMException TExcept(S.c_str(), TERMINATE);
    LogError(TExcept);
    throw TExcept;
  }
...
void ClassXG::push_front(float D) {
  ...
  if(nfront[hh] > front_size-2){ // space to allocate plus top of stack indicator
    string S = string("'") + Name + " (XG)' too many fronts in hru = " + longtoStr(hh+1).c_str();
    CRHMException TExcept(S.c_str(), TERMINATE);
    LogError(TExcept);
    throw TExcept;
  }
...
void ClassXG::finish(bool good) {
  for(hh = 0; chkStruct(); ++hh) {
//    LogMessageA(hh, string("'" + Name + " (XG)'  contrib_area  (mm) (mm*hru) (mm*hru/basin): ").c_str(), contrib_area[hh], hru_area[hh], basin_area[0]);
  }
  LogDebug(" ");
}
...
void ClassSoilX::decl(void) {
  ...
  Description = "'Handles soil moisture throughout the year. Expanded to handle frost depth' \
                 'Standard version,' \
                 'Version with Culvert limited runoff.'";
  ...
  declstatdiag("cum_gw_flow", NHRU, "Accumulation of drainage from groundwater reservoir.", "(mm)", &cum_gw_flow);
  ...
  declgetvar("*", "Zd_front", "(m)", &Zd_front, &Zd_front_lay);
  ...
  declparam("Dts_runoff_K", NHRU, "[0.0]", "0.", "100.0", "daily detention storage runoff drainage factor.", "(mm/d)", &Dts_runoff_K);
...
void ClassSoilX::run(void) {
  ...
  for(hh = 0; chkStruct(); ++hh) {
    ...
    if(nstep == 0){
      if(!NO_Freeze[hh] && (Zd_front_lay[0][hh] != 0.0 || Zd_front_lay[1][hh] != 0.0 || Zd_front_lay[2][hh] != 0.0)){

        long ll; // track soil layer
        long ff; // track fronts

        for(ll = 0; ll < depths_size; ++ll)
          thaw_layers_lay[ll][hh] = 0.0; // start all frozen

        float last_depth = 0.0; // last depth handled
        float layer_start = 0.0; // start of current layer
        float layer_end = 0.0; // end of current layer
        bool next_front;
        ll = 0;

        for(ff = 0; ff < nlay-1; ++ff){
          if(Zd_front_lay[ff][hh] == 0.0 && Zd_front_lay[ff+1][hh] == 0.0) // all fronts handled
            break;
          next_front = false;

          while(ll < depths_size && Zd_front_lay[ff][hh] != 0.0 && !next_front){
            layer_end += depth_layers_lay[ll][hh];
            if(Zd_front_lay[ff][hh] < 0.0){ // frozen to this depth
              if(fabs(Zd_front_lay[ff][hh]) >= layer_end){ // frozen to bottom of layer
                last_depth = layer_end;
              }
              else {
                if(Zd_front_lay[ff+1][hh] == 0.0){ // all thawed below
                  if(fabs(Zd_front_lay[ff][hh]) > layer_start && fabs(Zd_front_lay[ff][hh]) < layer_end)
                    thaw_layers_lay[ll][hh] = (layer_end - fabs(Zd_front_lay[ff][hh]))/depth_layers_lay[ll][hh];
                  else
                    thaw_layers_lay[ll][hh] = 1.0;

                  last_depth = layer_end;
                }
                else{
                  next_front = true; // goto next front
                }
              }
            }
            else{ // if(Zd_front_lay[ff][hh] > 0.0){ // thawed to this depth
              if(Zd_front_lay[ff][hh] >= layer_end){ // frozen to bottom of layer
                thaw_layers_lay[ll][hh] = (layer_end - last_depth)/depth_layers_lay[ll][hh];
                last_depth = layer_end;
              }
              else {
                thaw_layers_lay[ll][hh] = (Zd_front_lay[ff][hh] - last_depth)/depth_layers_lay[ll][hh];
                last_depth = Zd_front_lay[ff][hh];
                next_front = true; // goto next front
              }
            }
            if(!next_front){
              layer_start += depth_layers_lay[ll][hh]; // add current layer depth
              ++ll;
            }
            else
              layer_end -= depth_layers_lay[ll][hh]; // cancels double addition of depth
          } // while ll
        } // for ff
      }
...
//******Add infiltration to soil and compute excess
    ...
    if(soil_moist_max[hh] > 0.0){
      ...
      soil_rechr[hh] = soil_rechr[hh] + potential; // infiltrates into entire upper layer
...
//  Handle subsurface runoff
      ...
      float s2gw_k = soil_gw_K[hh]/Global::Freq*thaw_layers_lay[0][hh]; // regulate by amount of unfrozen lower layer
...
//  Handle excess to interflow or runoff
      ...
      if(!soil_ssr_runoff[hh] && excs > 0.0){ // to interflow regulated by amount of unfrozen upper layer
	      soil_ssr[hh] += excs*thaw_layers_lay[0][hh];
        excs = excs*(1.0 - thaw_layers_lay[0][hh]);
      }
    }
    else{ // soil_moist_max <= 0.0, i.e. Pond
      excs = infil[hh] + snowinfil_buf[hh] + condense;
   ...
   if(inhibit_evap[hh] == 1)  // when snowcover
     const_cast<float *>  (Dts_runoff_K)[hh] = Dts_snow_runoff_K[hh];
   if(inhibit_evap[hh] == 0)  // when no snowcover
     const_cast<float *>  (Dts_runoff_K)[hh] = Dts_organic_runoff_K[hh];
...
//****** et_type = 2 - evaporation + transpiration
  ...
  //******Soil moisture accounting  Remember that soil_rechr[hh] includes soil_moist[hh]
    ...
    else if((soil_moist_max[hh] > 0.0 || Sdmax[hh] > 0.0) && evap_from_runoff[hh] > 0.0){ // take from runoff
      if(soil_runoff[hh] > hru_evap_buf[hh]){
        hru_actet[hh] = hru_evap_buf[hh];
        soil_runoff[hh] -= hru_evap_buf[hh];
      }
      else{ // assume to be lake
        hru_actet[hh] = soil_runoff[hh];
        soil_runoff[hh] = 0.0;
      }
    }
...
ClassPCM* ClassPCM::klone(string name) const{
  return new ClassPCM(name);
}

void ClassPCM::decl(void) {

  Description = "'Pothole Cascade Model(Shook and Pomeroy, 2011).' \
                 'Inputs are observations Precip (mm/int) and Evap (mm/int), ' \
                 'Inputs are variables Precip_Var (mm/int) and variable Evap_Var (mm/int), '";

  variation_set = VARIATION_0;

  declreadobs("Precip", NHRU, "Precipitation", "(mm/int)", &Precip, HRU_OBS_misc);

  declreadobs("Evap", NHRU, "evaporation", "(mm/int)", &Evap, HRU_OBS_misc);

  variation_set = VARIATION_1;

  declgetvar("*", "Precip_Var", "(mm/int)", &Precip_Var);

  declgetvar("*", "Evap_Var", "(mm/int)", &Evap_Var);


  variation_set = VARIATION_ORG;

  decllocal("total_basin_area", NHRU, "total_basin_area", "(m^2)", &total_basin_area);
  ...
  declparam("ROF", NHRU, "[1.0]", "0.0", "1.0", "Runoff fraction", "()", &ROF);
...
void ClassPCM::init(void) {
  ...
  for(hh = 0; chkStruct(); ++hh){
    ...
    total_basin_area[hh] = 0.0;
    for (long jj = 0; jj < (long) NumSloughs[hh]; ++jj){
      current_volume[jj][hh] = Init_V_N[jj][hh];
      wetland_drainage[jj][hh] = wetland_drainage_area(Max_A_N[jj][hh]);
      max_slough_volume[hh] += Max_V_N[jj][hh];
      max_slough_area[hh] += Max_A_N[jj][hh];
      total_basin_area[hh] += wetland_drainage[jj][hh];
    }
  }
}

void ClassPCM::run(void) {

  float largest_value, transferred_volume, initial_vol, Precip_, Evap_;
  const float tolerance = 0.1;
  long iter_count, destination;
  const long iter_max = 100;
  bool done = false;
  ...
  for(hh = 0; chkStruct(); ++hh) {
    switch (variation){
      ...
      break;
      case VARIATION_1:
      Precip_ =  Precip_Var[hh];
      Evap_ =  Evap_Var[hh];
      break;
    } // switch

    for (long jj = 0; jj < (long) NumSloughs[hh]; ++jj)
      calc_h_and_S(Max_V_N[jj][hh], Max_A_N[jj][hh], S_values[jj][hh], h_values[jj][hh]);

// apply precip/evap
    if(Precip_ > 0.0){
      done = true;
      for (long jj = 0; jj < (long) NumSloughs[hh]; ++jj){
// apply rainfall // do direct Precip + runoff // get current water area
    areafrac[hh] = areafraction(Max_A_N[jj][hh], current_volume[jj][hh], S_values[jj][hh], h_values[jj][hh]);

// do direct Precip on water
    current_volume[jj][hh] = current_volume[jj][hh] + (Precip_*Max_A_N[jj][hh]*areafrac[hh])/1000.0;

// now do runoff from unwetted upland
    current_volume[jj][hh] = current_volume[jj][hh] + (Precip_ * ROF[hh] /1000.0) * (wetland_drainage[jj][hh] - areafrac[hh] * Max_A_N[jj][hh]);
...
// now do slough #1
    ...
    if(Evap_ > 0.0){ // evaporate water 1 mm at a time
      outflow_volume[hh] = 0.0;
      long i_evap = int(-1.0 * Evap_);
...
// calculate stats & write to stdout
    ...
    final_vol[hh] = 0.0;
    for (long jj = 0; jj < (long) NumSloughs[hh]; ++jj)
      final_vol[hh] += current_volume[jj][hh];

    for (long jj = 0; jj < (long) NumSloughs[hh]; ++jj)
      current_area[jj][hh] = areafraction(Max_A_N[jj][hh], current_volume[jj][hh], S_values[jj][hh], h_values[jj][hh] ) * Max_A_N[jj][hh];

    initial_vol = 0.0;
    final_area[hh] = 0.0;
    for (long jj = 0; jj < (long) NumSloughs[hh]; ++jj){
      initial_vol += Init_V_N[jj][hh];
      final_area[hh] += current_area[jj][hh];
    }

    delta_vol[hh] = final_vol[hh] - initial_vol;
    volfrac[hh] = final_vol[hh]/max_slough_volume[hh];
    areafrac[hh] = final_area[hh]/max_slough_area[hh];

// calculate fractional outflow
    if (Precip_ > 0.0)
      runofffrac[hh] = 1.0 - (delta_vol[hh] / ((Precip_/1000.0) * total_basin_area[hh]));
    else
      runofffrac[hh] = 0.0;
...
void ClassPCM::finish(bool good) {
  for(hh = 0; chkStruct(); ++hh) {
    LogMessage (("HRU " + longtoStr(hh+1) + ": '" + Name.c_str() + " (PCM)'  NumSloughs: ").c_str(), NumSloughs[hh]);
    LogMessageA(hh, string("'" + Name + " (PCM)'  total_basin_area  (mm) (mm*hru) (mm*hru/basin): ").c_str(), total_basin_area[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (PCM)'  max_slough_area   (mm) (mm*hru) (mm*hru/basin): ").c_str(), max_slough_area[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (PCM)'  max_slough_volume   (mm) (mm*hru) (mm*hru/basin): ").c_str(), max_slough_volume[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (PCM)'  final_vol   (mm) (mm*hru) (mm*hru/basin): ").c_str(), final_vol[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (PCM)'  final_area   (mm) (mm*hru) (mm*hru/basin): ").c_str(), final_area[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (PCM)'  delta_vol   (mm) (mm*hru) (mm*hru/basin): ").c_str(), delta_vol[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (PCM)'  outflow_volume   (mm) (mm*hru) (mm*hru/basin): ").c_str(), outflow_volume[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (PCM)'  volfrac   (mm) (mm*hru) (mm*hru/basin): ").c_str(), volfrac[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (PCM)'  areafrac   (mm) (mm*hru) (mm*hru/basin): ").c_str(), areafrac[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (PCM)'  runofffrac   (mm) (mm*hru) (mm*hru/basin): ").c_str(), runofffrac[hh], hru_area[hh], basin_area[0]);

    for (long ii = 0; ii < (long) NumSloughs[hh]; ++ii){
      delete[] current_area[ii];  //Array [NumSloughs] [nhru]
      delete[] current_depth[ii];  //Array [NumSloughs] [nhru]
      delete[] current_volume[ii];  //Array [NumSloughs] [nhru]
      delete[] S_values[ii];  //Array [NumSloughs] [nhru]
      delete[] h_values[ii];  //Array [NumSloughs] [nhru]
      delete[] wetland_drainage[ii];  //Array [NumSloughs] [nhru]
    }

  delete[] current_area; current_area = NULL;
  delete[] current_depth; current_depth = NULL;
  delete[] current_volume; current_volume = NULL;
  delete[] S_values; S_values = NULL;
  delete[] h_values; h_values = NULL;
  delete[] wetland_drainage; h_values = NULL;
  }
  LogDebug(" ");
}
...
float ClassPCM::areafraction(float maxarea, float volume, float S, float h){
...
void ClassPCM::calc_h_and_S(float maxvolume, float maxarea, float &S, float &h){
...
float ClassPCM::wetland_drainage_area(float maxarea){ // based on scaling relationships

   if (maxarea > 1000.0)
    return exp(3.44329) * pow(maxarea, 0.738377);
   else
    return 2893.887;

} //end wetland_drainage_area
...
ClassTest* ClassTest::klone(string name) const{
  return new ClassTest(name);
}

float ClassTest::FunctionA(const float *L, long hh) {
  return Delay->ChangeLag(L, hh);
}

float ClassTest::FunctionB(const float *X, long hh) {
  return Delay->ChangeStorage(X, hh);
}

void ClassTest::decl(void) {
  Description = "'Written to test changing Clark coefficient dynamically.'";

  declstatdiag("cumTest_in", NHRU, "cumulative inflow from other HRUs", "(mm*km^2)", &cumTest_in);

  declvar("Test_out", NHRU, "HRU outflow", "(mm*km^2/int)", &Test_out);

  decldiag("Last_Lag", NHRU, "last interval Lag", "(h)", &Last_Lag);

  decldiag("Last_Kstorage", NHRU, "last interval Kstorage", "(d)", &Last_Kstorage);

  declstatdiag("cumTest_out", NHRU, "cumulative HRU outflow", "(mm*km^2)", &cumTest_out);

  decldiag("In_storage", NHRU, "melt runoff in storage at the beginning of interval!", "(mm)", &In_storage);


  declparam("Kstorage", NHRU, "[0.0]", "0.0","200.0", "storage constant", "(d)", &Kstorage);

  declparam("Lag", NHRU, "[0.0]", "0.0","1.0E4", "lag delay", "(h)", &Lag);

  declgetvar("*", "Test_in", "(mm)", &Test_in);

  declgetvar("*", "new_Kstorage", "(d)", &new_Kstorage);

  declgetvar("*", "new_Lag", "(h)", &new_Lag);
}

void ClassTest::init(void) {

  nhru = getdim(NHRU);

  Delay = new ClassClark(Test_in, Test_out, Kstorage, Lag, nhru);

  for(hh = 0; chkStruct(hh); ++hh){
    cumTest_in[hh] = 0.0;
    cumTest_out[hh] = 0.0;
    Last_Lag[hh] = 0.0;
    Last_Kstorage[hh] = 0.0;
    In_storage[hh] = 0.0;
  }
}

void ClassTest::run(void) {
  for(hh = 0; chkStruct(hh); ++hh){
    if(new_Lag[hh] != Last_Lag[hh])  //  || new_Lag[hh] < 0.0
      FunctionA(new_Lag, hh);

    if(new_Kstorage[hh] != Last_Kstorage[hh])
      In_storage[hh] = FunctionB(new_Kstorage, hh);

    Last_Lag[hh] = new_Lag[hh];
    Last_Kstorage[hh] = new_Kstorage[hh];

    cumTest_in[hh] += Test_in[hh];
    cumTest_out[hh] += Test_out[hh];
...
void ClassTest::finish(void) {

  for(hh = 0; chkStruct(); ++hh) {
    LogMessageA(hh, string("'" + Name + " (Test)' cumTest_in       (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumTest_in[hh], 1, 1);
    LogMessageA(hh, string("'" + Name + " (Test)' cumTest_out      (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumTest_out[hh], 1, 1);
    LogMessageA(hh, string("'" + Name + " (Test)' Delay_in_storage (mm) (mm*hru) (mm*hru/basin): ").c_str(), Delay->Left(hh), 1, 1);
    LogDebug(" ");
  }
}
...
void ClassSWEslope::decl(void) {
  ...
  declvar("Slide_out", NHRU, "outgoing snow slide transport SWE", "(mm/int)", &Slide_out);

  declvar("Slide_in", NHRU, "incoming snow slide transport SWE", "(mm/int)", &Slide_in);

  declstatdiag("cumSlide_in", NHRU, "incoming cumulative Slide transport SWE from other HRU", "(mm)", &cumSlide_in);

  declstatdiag("cumSlide_out", NHRU, "outgoing cumulative Slide transport SWE to other HRU", "(mm)", &cumSlide_out);
...
/* parameters */
  ...
  declparam("wheretoSlope", NHRU, "[0]", "0", "1000", "destination HRU of slides from this HRU", "()", &wheretoSlope);
  ...
  declputvar("*", "SWE", "(mm)", &SWE);
  declgetvar("*", "hru_drift", "(mm/int)", &hru_drift);
  declgetvar("*", "rho", "((kg/m^3))", &rho);
}
...
void ClassSWEslope::run(void) {
  ...
  for (long hhh = 0; chkStruct(hhh); ++hhh) {
    ...
    if(wheretoSlope[hh] > 0) // clear destination value
      Slide_in[wheretoSlope[hh]-1] = 0.0;

    if(hru_GSL[hh] > 25.0 && wheretoSlope[hh] > 0){
      float den_snow;
      if (use_rho[hh])
        den_snow = rho[hh];
      else
      ...
      if(SWE[hh] > Hd[hh]){
        Slide_out[hh] = SWE[hh];
        cumSlide_out[hh] += SWE[hh];

        float corrected = SWE[hh]*hru_area[hh]/hru_area[wheretoSlope[hh]-1];
        Slide_in[wheretoSlope[hh]-1] = corrected;
        cumSlide_in[wheretoSlope[hh]-1] += corrected;
...
void ClassSWEslope::finish(void) {

  for(hh = 0; chkStruct(); ++hh) {
    LogMessageA(hh, string("'" + Name + " (SWESlope)' cumSlide_in (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumSlide_in[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (SWESlope)' cumSlide_out (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumSlide_out[hh], hru_area[hh], basin_area[0]);
    LogDebug(" ");
  }
}
...
void Classquinton::decl(void) {
  ...
  declvar("cump", NHRU, "cumulative precipitation", "(mm)", &cump); //
...
//  declparam("k_range", NHRU, "[0]", "0", "2", "hydraulic conductivity range , 0=normal/1=high/2=low", "()", &k_range);
  ...
  declparam("K_a", NHRU, "[0.011]", "0.0", "0.1", "empirical constant for K-d, pow(a*d, b)", "()", &Ka);

  declparam("K_b", NHRU, "[-4.2178]", "-10.0", "-0.1", "empirical constant for K-d, a*pow(d, b)", "()", &Kb);
  ...
  declgetvar("Qdrift", "driftmelt", "()", &driftmelt);
...
const float rho_a =    1.2; // (kg/m3) air
const float rho_i =  920.0; // (kg/m3) ice
const float rho_w = 1000.0; // (kg/m3) water

const float c_a = 1010.0; // (J/kg/K) air
const float c_i = 2120.0; // (J/kg/K) ice
const float c_w = 4185.0; // (J/kg/K) water
...
// does not matter if frozen or unfrozen
    ...
    LogMessageA(hh, "(Hummock) - water content (m3) (m/m2): ", c*length[hh], length[hh]);
  } // for nhru
}
...
//      tension_lay[nn][hh] = 0.0;
      ...
      if(n_const_lay[nn][hh] > 0.001){ // use Van Genuchten
        ...
        float alph = a_const_lay[nn][hh]*m - 1.0;
// bubbling pressure = 1/alph
        float fieldtheta = (por_s[soil_type_lay[nn][hh]] - Residual_lay[nn][hh])*pow(2.0, -m);
        float thawedthislayer = dmelt[hh] - (d_cum - d_lay[nn][hh]);
        ...
        if(capillary_lay[nn][hh] > 0.0) {
          ...
          if(tension > 1.0/alph){ // greater than bubbling pressure
            float theta = (por_s[soil_type_lay[nn][hh]] - Residual_lay[nn][hh])
                          *pow(1.0 + pow(alph*tension, n_const_lay[nn][hh]), -m);
            float excess = capillary_lay[nn][hh]
                             - theta*d_lay[nn][hh]/por_s[soil_type_lay[nn][hh]]; // (m)
    ...
    if(Depth[hh] > 0.0) {
//      const float k_a[] = {0.0115, 0.0675, 0.0061}; // ()  hydraulic conductivity constant
//      const float k_b[] = {-4.2927, -3.8364, -4.1315}; // ()  hydraulic conductivity constant

      k[hh] = Ka[hh]*pow(d_surface[hh], Kb[hh]); // (m/day)
      if(k[hh] > 1250) k[hh] = 1250;
...
//        Delayflow->ChangeLag(transit[hh]*24.0, hh);
    ...
    flowin[hh] += hru_p[hh]/1000.0; // handle precipitation why /1000?
    cump[hh] += hru_p[hh];
...
void Classquinton::finish(bool good) {
  ...
  for(int hh = 0; hh < nhru; ++hh) {
    ...
    LogMessageA(hh, "(Hummock) - water content      (m3) (m/m2): ", c*length[hh], length[hh]);
    LogMessageA(hh, "(Hummock) - cumulative flowin  (m3) (m/m2): ", cumflowin[hh]*length[hh], length[hh]);
    LogMessageA(hh, "(Hummock) - cumulative precip  (m3) (m/m2): ", cump[hh]*length[hh]/1000, length[hh]);
    LogMessageA(hh, "(Hummock) - cumulative flowout (m3) (m/m2): ", cumflow[hh]*length[hh], length[hh]);
    LogMessageA(hh, "(Hummock) - flowout in storage (m3) (m/m2): ", Delayflow->Left(hh)*length[hh], length[hh]);
    LogMessageA(hh, "(Hummock) - cumulative runoff  (m3) (m/m2): ", cumrunoff[hh]*length[hh], length[hh]);
    LogMessageA(hh, "(Hummock) - runoff in storage  (m3) (m/m2): ", Delayrunoff->Left(hh)*length[hh], length[hh]);
    LogDebug(" ");
...
void Classqdrift::decl(void) {
  ...
  decllocal("driftmeltOrg", NHRU, "snow melt", "(m^3/int)", &driftmelt); // pack

  declvar("driftmelt", NHRU, "snow melt with delay", "(m^3/int)", &driftmeltDly); // with delay

  decllocal("cumdriftmeltOrg", NHRU, "cumulative snow melt (units?)", "(m^3)", &cumdriftmelt); // pack
  ...
  declgetvar("*", "hru_p", "()", &hru_p);
  declgetvar("*", "Qm", "()", &Qm);
  declputvar("*", "cump", "()", &cump);
}
...
//    if(Type[hh] != DRIFT)
//      const_cast<long*> (DrainTo) [hh] = 0;

    if(hh == 0) LogDebugT("Initial");

    if(Type[hh] != DRIFT) continue;  // drift

    float c = 0.0;
    if(SWE[hh] > 0.0)
      c = length[hh]*InitSWE[hh]/1E3;
    LogMessageA(hh, "(Drift  ) - water content (m3) (m/m2): ", c, length[hh]);
  }
}
...
void Classqdrift::run(void) {
  ...
  for (int hh = 0; hh < nhru; hh++) {
    ...
    if(p != NULL) { // handle precipitation
      driftmelt[hh] += (hru_p[0]*length[hh]/1E3);
      cump[hh] += p[0];
    }
...
void Classqdrift::finish(bool good) {
  ...
  for (int hh = 0; hh < nhru; hh++) {
    ...
    LogMessageA(hh, "(Drift  ) - water content (m3) (m/m2): ", c, length[hh]);
    LogMessageA(hh, "(Drift  ) - total precip  (m3) (m/m2): ", cump[hh]*length[hh]/1E3, length[hh]);
    LogMessageA(hh, "(Drift  ) - water storage (m3) (m/m2): ", Delaymelt->Left(hh), length[hh]);
    LogDebug(" ");
  }
...
void Classqmelt::run(void) {
  ...
  if(start) { // calculate daily regression
    ...
    for(int hh = 0; hh < nhru; ++hh) {
      if(hru_tmean[0] - TIa0Mn[hh] > 0.0)
        QmD[hh] =  (hru_tmean[0] - TIa0Mn[hh])*TIa1Mn[hh];   // mean air temperature degree day
      else
        QmD[hh] = 0.0;
  ...
  for(int hh = 0; hh < nhru; ++hh) {
    ...
    if(hru_t[0] > 0.0 && hru_tmean[0] > 0.0)
      Qm[hh] = QmD[hh]*hru_t[0]/tpos[0];  // distribute daily to interval
    else
      Qm[hh] = 0.0;
...
Classglacier_org* Classglacier_org::klone(string name) const{
  return new Classglacier_org(name);
}

void Classglacier_org::decl(void) {

  Description = "'Energy-budget glacier model using pbsmSnobal', \
                 'glacier using Brunt et al', \
                 'glacier using input variable Qnsn_Var (W/m^2*int) from CanopyClearing etc.', \
                 'glacier using input observation Qnsn (W/m^2*int)', \
                 'glacier using input observation QnD (MJ/m^2*d)'";
  ...
  declvar("runoff", NHRU, "ice melt runoff", "(mm/d)", &runoff);

  declstatdiag("cumrunoff", NHRU, "cummulative ice melt runoff", "(mm)", &cumrunoff);
...
void Classglacier_org::init(void) {
  ...
  for(hh = 0; hh < nhru; ++hh) {
    ...
    if(variation == VARIATION_ORG)
      if(nfactor[hh] != 0.0 && QnD == NULL){
        CRHMException TExcept("glacier_org: nfactor > 0.0 with observation 'QnD' not defined!", TERMINATE);
        LogError(TExcept);
      }
  }
  SWEDelay = new ClassClark(SWEmelt, SWEmelt_delayed, SWEstorage, SWELag, nhru);
...
void Classglacier_org::run(void) {
  ...
  if(nstep == 0 || Global::Freq == 1){ // end of every day
    ...
    for(hh = 0; chkStruct(); ++hh) {
      ...
      enum Handle {cbare, csnow, cfirn, cice} Cover = cbare;

      if(SWE[hh] > 0.0)
        Cover = csnow; // snow cover
      else if(ice[hh] > 0.0)
        Cover = cice; // ice cover

      switch (Cover){

      case cbare : // bare ground
        LW_ebsm[hh] = 0.0;
        u_ebsm[hh] = 0.0;
        break;
      case csnow : // snow cover
        if(variation == VARIATION_ORG && (tfactor[hh] > 0.0 || nfactor[hh] > 0.0) && meltflag[hh] == 1) {
          if(delay_melt[hh] <= julian("now")) {
            ...
            if (SWEmelt[hh] <= 0.0)
              ...
              if(SWE[hh] > SWEmelt[hh])
                SWE[hh] = SWE[hh] - SWEmelt[hh];
              else {
                SWEmelt[hh] = SWE[hh];
                SWE[hh] = 0.0;
              }
              cumSWEmelt[hh] += SWEmelt[hh];
            }
          }
        }
        else if(meltflag[hh] == 1 && delay_melt[hh] <= julian("now")) {
          ...
          switch (variation) {
            ...
            case VARIATION_ORG :
              if(QnD != NULL && Use_QnD[hh]){ // observation available (MJ/m^2*d)
                ...
                Qn_ebsm[hh] = -0.53+0.47*(QdroD[hh] + QdfoD[hh])*(0.52+0.52*sunact[hh]/sunmax[hh])*(1.0 - max<float> (Albedo[hh], ice_Albedo[hh]));
          ...
          if(u_ebsm[hh] > 0.0) {
            melt = u_ebsm[hh]/316.8*1000.0; // thermal quality B=0.95. 316.8 = 333.5*0.95 (kJ/kg), (mm/d)

            if(melt + LW_ebsm[hh] > LWmax[hh]) {
              SWEmelt[hh] = melt - (LWmax[hh] - LW_ebsm[hh]);
              if(SWEmelt[hh] >= SWE[hh]) {
                SWEmelt[hh] = SWE[hh] + LW_ebsm[hh];
                SWE[hh] = 0.0;
                LW_ebsm[hh] = 0.0;
                Qmelt[hh] = melt - SWEmelt[hh];
              }
              else if(SWE[hh] > melt){
                SWE[hh] = SWE[hh] - melt;
                LW_ebsm[hh] = LWmax[hh];
        ...
        else { // refreeze any liquid water
          if(tmin[hh] < 0.0)
            u_ebsm[hh] = SWE[hh]*(2.115+0.00779*tmin[hh])*tmin[hh]/1000.0;
          if(LW_ebsm[hh] > 0.0){
            u_ebsm[hh] = u_ebsm[hh] + LW_ebsm[hh]*333.5/1000.0;
      ...
      case cice: // ice
        if(variation == VARIATION_ORG && (tfactor[hh] > 0.0 || nfactor[hh] > 0.0)) {
          ...
          Qmelt[hh] = Qmelt[hh]/316.8*1000.0; // thermal quality B=0.95. 316.8 = 333.5*0.95 (kJ/kg), now (mm/d)

          if (Qmelt[hh] <= 0.0)
            Qmelt[hh] = 0.0;
       } // if

        if(Qmelt[hh] > 0.0 && ice[hh] > 0.0) {
          if(Qmelt[hh] >= ice[hh]){ // melt layer
            icemelt[hh] = ice[hh];
            Qmelt[hh] -= icemelt[hh];
            ice[hh] = 0.0;
...
void Classglacier_org::finish(bool good) {

  for(hh = 0; chkStruct(); ++hh) {
    LogMessageA(hh, string("'" + Name + " (glacier_org)' SWE          (mm) (mm*hru) (mm*hru/basin): ").c_str(), SWE[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier_org)' cumSWEmelt   (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumSWEmelt[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier_org)' cumicemelt   (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumicemelt[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier_org)' ice_change   (mm) (mm*hru) (mm*hru/basin): ").c_str(), ice_init[hh]*1000.0 - ice[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier_org)' cummeltrunoff(mm) (mm*hru) (mm*hru/basin): ").c_str(), cummeltrunoff[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier_org)' cumrunoff    (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumrunoff[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier_org)' cuminfil     (mm) (mm*hru) (mm*hru/basin): ").c_str(), cuminfil[hh], hru_area[hh], basin_area[0]);
    LogDebug(" ");
  }
  delete SWEDelay;
  delete iceDelay;
...
Classglacier2* Classglacier2::klone(string name) const{
  return new Classglacier2(name);
}

void Classglacier2::decl(void) {
  ...
  decldiagparam("firn_h_init", NDEFN, "[0.0]", "0.0", "100.0", "initial depths of firn densification layers. 0.0 indicates end of firn layers", "(m)", &firn_h_init, &firn_h_array_init, Global::nlay);
  ...
  declparam("rho0", NHRU, "[500]", "100.0", "700.0", "zero depth intersection of ln(rho/(rhoice-rho)) could equal average density over first one or two meters of snow.", "(m/yr)", &rho0);
  ...
  declparam("SWE_to_firn_Julian", NHRU, "[244]", "1", "366", "convert any SWE to firn (Julian day)", "()", &SWE_to_firn_Julian);
...
void Classglacier2::init(void) {

  nhru = getdim(NHRU);
  nlay = getdim(NLAY);

  if(nlay < 2) {
    string S = string("'") + Name + " (glacier2)' project file nlay(number of layers) must be greater than 1";
    CRHMException TExcept(S.c_str(), TERMINATE);
    LogError(TExcept);
    throw TExcept;
  }
  ...
  for(hh = 0; hh < nhru; ++hh) {
    ...
    if(nfirn[hh] >= nlay){
      string S = string("'") + Name + " (glacier2)' global 'nlay'  must be greater than number of firn layers in hru = " + longtoStr(hh+1).c_str();
      CRHMException TExcept(S.c_str(), TERMINATE);
      LogError(TExcept);
    }
...
// calculate SWE of firn
          ...
          switch (variation) {
            ...
            case VARIATION_ORG :
              if(QnD != NULL && Use_QnD[hh]){ // observation available (MJ/m^2*d)
                ...
                Qn_ebsm[hh] = -0.53+0.47*(QdroD[hh] + QdfoD[hh])*(0.52+0.52*sunact[hh]/sunmax[hh])*(1.0 - max<float> (Albedo[hh], firn_Albedo[hh]));
      ...
      case cice:
        ...
        if(nfirn[hh] > 0 && Qmelt[hh] > 0.0){ // melt firn
          long lay = 0;
          float h2o;
          while(nfirn[hh] > 0 && Qmelt[hh] > 0.0){
            h2o = firn_dens_array[lay][hh]*firn_h_array[lay][hh];
...
void Classglacier2::finish(bool good) {

  for(hh = 0; chkStruct(); ++hh) {
    LogMessageA(hh, string("'" + Name + " (glacier2)' SWE          (mm) (mm*hru) (mm*hru/basin): ").c_str(), SWE[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier2)' cumSWEmelt   (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumSWEmelt[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier2)' firn_init   (mm) (mm*hru) (mm*hru/basin): ").c_str(), firn_init[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier2)' firn_final  (mm) (mm*hru) (mm*hru/basin): ").c_str(), firn[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier2)' cumfirnmelt   (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumfirnmelt[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier2)' cumSWE_2firn (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumSWE_2firn[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier2)' firn_change (mm) (mm*hru) (mm*hru/basin): ").c_str(), firn[hh] - firn_init[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier2)' cumicemelt   (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumicemelt[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier2)' ice_change  (m) (mm*hru) (mm*hru/basin): ").c_str(), ice_init[hh]*1000.0 - ice[hh], hru_area[hh], basin_area[0]);

    LogMessageA(hh, string("'" + Name + " (glacier2)' cummeltrunoff   (mm) (mm*hru) (mm*hru/basin): ").c_str(), cummeltrunoff[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier2)' cumrunoff    (mm) (mm*hru) (mm*hru/basin): ").c_str(), cumrunoff[hh], hru_area[hh], basin_area[0]);
    LogMessageA(hh, string("'" + Name + " (glacier2)' cuminfil    (mm) (mm*hru) (mm*hru/basin): ").c_str(), cuminfil[hh], hru_area[hh], basin_area[0]);
    LogDebug(" ");
  }
  delete SWEDelay;
  delete firnDelay;
